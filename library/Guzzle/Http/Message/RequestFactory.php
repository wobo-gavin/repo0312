 ...
 * /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Http\Message\Request and /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Http\Message\EntityEnclosingRequest
 * objects.
 *
 * If you need to extend the Request or EntityEnclosingRequest classes, then
 * this default factory implementation will not work for your /* Replaced /* Replaced /* Replaced client */ */ */, though
...
class RequestFactory
{
     ...
     */
    protected static $requestClass = '/* Replaced /* Replaced /* Replaced Guzzle */ */ */\\Http\\Message\\Request';

    /**
     * @var string Class to instantiate for POST and PUT requests
     */
    protected static $entityEnclosingRequestClass = '/* Replaced /* Replaced /* Replaced Guzzle */ */ */\\Http\\Message\\EntityEnclosingRequest';
     ...
     *     # scheme - e.g. http
     *     # host - e.g. www./* Replaced /* Replaced /* Replaced guzzle */ */ */-project.com
     *     # port - e.g. 80
     *     # user - e.g. michael
     *     # pass - e.g. rocks
