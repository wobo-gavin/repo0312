...
class Server extends AbstractSubject
{
    ...
    public function flush()
    {
        ...
        return RequestFactory::getInstance()->newRequest('DELETE', $this->getUrl() . '/* Replaced /* Replaced /* Replaced guzzle */ */ */-server/requests')
    ...
    public function enqueue($responses)
    {
        ...
        $response = RequestFactory::getInstance()->newRequest(
            'PUT',
            $this->getUrl() . '/* Replaced /* Replaced /* Replaced guzzle */ */ */-server/responses',
            null,
            json_encode($data)
        )->send();
    ...
    public function getReceivedRequests($hydrate = false)
    {
        ...
        if ($this->isRunning()) {
            $response = RequestFactory::getInstance()->newRequest('GET', $this->getUrl() . '/* Replaced /* Replaced /* Replaced guzzle */ */ */-server/requests')->send();
    ...
    public function stop()
    {
        ...
        return RequestFactory::getInstance()->newRequest('DELETE', $this->getUrl() . '/* Replaced /* Replaced /* Replaced guzzle */ */ */-server')->send()
            ->getStatusCode() == 200;
    }
}