...
class Server
{
    ...
    public function flush()
    {
        ...
        return RequestFactory::getInstance()
            ->newRequest('DELETE', $this->getUrl() . '/* Replaced /* Replaced /* Replaced guzzle */ */ */-server/requests')
    ...
    public function enqueue($responses)
    {
        ...
        $response = RequestFactory::getInstance()
            ->newRequest('PUT', $this->getUrl() . '/* Replaced /* Replaced /* Replaced guzzle */ */ */-server/responses', null, json_encode($data))
            ->send();
    ...
    public function stop()
    {
        ...
        return RequestFactory::getInstance()
            ->newRequest('DELETE', $this->getUrl() . '/* Replaced /* Replaced /* Replaced guzzle */ */ */-server')->send()
            ->getStatusCode() == 200;
    }
}