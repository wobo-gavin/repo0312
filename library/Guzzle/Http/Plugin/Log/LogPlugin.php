...
namespace /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Http\Plugin\Log;
...
class LogPlugin extends AbstractPlugin
{
    ...
    {
        if ($subject->is('/* Replaced /* Replaced /* Replaced Guzzle */ */ */\\Http\\Message\\RequestInterface')) {
    ...
    private function log(RequestInterface $request, Response $response = null, $moreInfo = null)
    {
        ...
        $this->logger->log(trim($message), $priority, '/* Replaced /* Replaced /* Replaced guzzle */ */ */_request', $this->hostname);
    }
}