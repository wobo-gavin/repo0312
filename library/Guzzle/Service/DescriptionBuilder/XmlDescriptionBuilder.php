...
class XmlDescriptionBuilder implements DescriptionBuilderInterface
{
    ...
    public function build()
    {
        ...
        // Check if the optional </* Replaced /* Replaced /* Replaced client */ */ */> node is supplied with the /* Replaced /* Replaced /* Replaced client */ */ */ class
        $/* Replaced /* Replaced /* Replaced client */ */ */ = (string)$xml->/* Replaced /* Replaced /* Replaced client */ */ */;
        if (!$/* Replaced /* Replaced /* Replaced client */ */ */) {
            // Use the default /* Replaced /* Replaced /* Replaced client */ */ */
            $/* Replaced /* Replaced /* Replaced client */ */ */ = '/* Replaced /* Replaced /* Replaced Guzzle */ */ */\\Service\\Client';
            $/* Replaced /* Replaced /* Replaced client */ */ */Args = array(
                '_/* Replaced /* Replaced /* Replaced client */ */ */_class' => array(
                    'value' => $/* Replaced /* Replaced /* Replaced client */ */ */
                )
            );
        } else {
            // Use a custom /* Replaced /* Replaced /* Replaced client */ */ */
            $reflection = new \ReflectionClass(str_replace('.', '\\', $/* Replaced /* Replaced /* Replaced client */ */ */));
            $parsed = Inspector::getInstance()->parseDocBlock($reflection->getDocComment());
            $/* Replaced /* Replaced /* Replaced client */ */ */Args = array_merge(array(
                '_/* Replaced /* Replaced /* Replaced client */ */ */_class' => array(
                    'value' => str_replace('.', '\\', $/* Replaced /* Replaced /* Replaced client */ */ */)
                )
            ), $parsed['args']);
            unset($reflection);
        }
        ...
        return new ServiceDescription((string)$xml->name, (string)$xml->description, (string)$xml->base_url, $commands, $/* Replaced /* Replaced /* Replaced client */ */ */Args);
    }
}