 ...
 * @/* Replaced /* Replaced /* Replaced guzzle */ */ */ visibility_timeout doc="The duration (in seconds) that the received messages are hidden from subsequent retrieve requests after being retrieved by a ReceiveMessage request."
 * @/* Replaced /* Replaced /* Replaced guzzle */ */ */ max_messages doc="The maximum number of messages to retrieve per request"
 */
