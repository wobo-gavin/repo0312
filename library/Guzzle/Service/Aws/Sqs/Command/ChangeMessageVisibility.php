 ...
 * @/* Replaced /* Replaced /* Replaced guzzle */ */ */ receipt_handle required="true" doc="The receipt handle associated with the message"
 * @/* Replaced /* Replaced /* Replaced guzzle */ */ */ visibility_timeout required="true" doc="The new value for the message's visibility timeout (in seconds)."
 */
