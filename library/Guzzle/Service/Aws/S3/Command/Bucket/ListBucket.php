 ...
 * @/* Replaced /* Replaced /* Replaced guzzle */ */ */ delimiter
 * @/* Replaced /* Replaced /* Replaced guzzle */ */ */ marker
 * @/* Replaced /* Replaced /* Replaced guzzle */ */ */ prefix
 * @/* Replaced /* Replaced /* Replaced guzzle */ */ */ max_keys doc="The number of keys to return per request"
 * @/* Replaced /* Replaced /* Replaced guzzle */ */ */ limit doc="The maximum number of objects to return"
 */
class ListBucket extends AbstractS3BucketCommand
{
     ...
     */
    protected $bucketIterator = '/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Service\Aws\S3\Model\BucketIterator';
    ...
    protected function process()
    {
        ...
        if ($this->get('xml_only')) {
            ...
            $this->result = call_user_func(array($className, 'factory'), $this->/* Replaced /* Replaced /* Replaced client */ */ */, $xml, $this->get('limit', -1));
        }
    }
