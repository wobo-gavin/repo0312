...
use /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Service\Aws\S3\Model\VersionBucketIterator;
 ...
 * @/* Replaced /* Replaced /* Replaced guzzle */ */ */ delimiter doc="A delimiter is a character that you specify to group keys"
 * @/* Replaced /* Replaced /* Replaced guzzle */ */ */ marker doc="Specifies the key in the bucket that you want to start listing from. Also, see version-id-marker."
 * @/* Replaced /* Replaced /* Replaced guzzle */ */ */ prefix doc=""
 * @/* Replaced /* Replaced /* Replaced guzzle */ */ */ max_keys doc="The number of keys to return per request"
 * @/* Replaced /* Replaced /* Replaced guzzle */ */ */ version_id_marker doc="Specifies the object version you want to start listing from. Also, see key-marker."
 */
