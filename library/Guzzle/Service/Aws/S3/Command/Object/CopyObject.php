 ...
 *
 * @/* Replaced /* Replaced /* Replaced guzzle */ */ */ key doc="Destination object key" required="true"
 * @/* Replaced /* Replaced /* Replaced guzzle */ */ */ bucket doc="Destination bucket" required="true"
 ...
 * @/* Replaced /* Replaced /* Replaced guzzle */ */ */ acl doc="Canned ACL to set on the copied object"
 * @/* Replaced /* Replaced /* Replaced guzzle */ */ */ storage_class doc="Use STANDARD or REDUCED_REDUNDANCY storage"
 * @/* Replaced /* Replaced /* Replaced guzzle */ */ */ copy_source doc="The bucket and key of the source object in the form of /bucket/key" required="true"
 * @/* Replaced /* Replaced /* Replaced guzzle */ */ */ copy_source_if_match doc="Copies the object if its entity tag (ETag) matches the specified tag"
 * @/* Replaced /* Replaced /* Replaced guzzle */ */ */ copy_source_if_none_match doc="Copies the object if its entity tag (ETag) is different than the specified ETag"
 * @/* Replaced /* Replaced /* Replaced guzzle */ */ */ copy_source_if_modified_since doc="Copies the object if it has been modified since the specified time"
 * @/* Replaced /* Replaced /* Replaced guzzle */ */ */ copy_source_if_unmodified_since doce="Copies the object if it hasn't been modified since the specified time"
 *
...
class CopyObject extends AbstractRequestObject
{
    ...
    {
        return $this->set('copy_source_if_unmodified_since', /* Replaced /* Replaced /* Replaced Guzzle */ */ */::getHttpDate($date));
    }
    ...
    {
        return $this->set('copy_source_if_modified_since', /* Replaced /* Replaced /* Replaced Guzzle */ */ */::getHttpDate($date));
    }
}