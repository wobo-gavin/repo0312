...
abstract class AbstractRequestObject extends AbstractS3BucketCommand
{
    ...
    {
        return $this->set('if_modified_since', /* Replaced /* Replaced /* Replaced Guzzle */ */ */::getHttpDate($since));
    }
    ...
    {
        return $this->set('if_unmodified_since', /* Replaced /* Replaced /* Replaced Guzzle */ */ */::getHttpDate($since));
    }
