...
class ListPartsIterator extends ResourceIterator
{
     ...
     * list parts request.
     *
     * @param S3Client $/* Replaced /* Replaced /* Replaced client */ */ */ The /* Replaced /* Replaced /* Replaced client */ */ */ responsible for sending subsquent requests
     ...
     */
    public static function factory(S3Client $/* Replaced /* Replaced /* Replaced client */ */ */, \SimpleXMLElement $result, $limit = -1)
    {
        $iterator = new self($/* Replaced /* Replaced /* Replaced client */ */ */, array(
            'limit' => $limit,
