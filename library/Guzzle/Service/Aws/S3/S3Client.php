 ...
 *
 * @/* Replaced /* Replaced /* Replaced guzzle */ */ */ access_key_id doc="AWS Access Key ID"
 * @/* Replaced /* Replaced /* Replaced guzzle */ */ */ secret_access_key doc="AWS Secret Access Key"
 * @/* Replaced /* Replaced /* Replaced guzzle */ */ */ region required="true" default="s3.amazonaws.com" doc="AWS Region endpoint"
 * @/* Replaced /* Replaced /* Replaced guzzle */ */ */ protocol required="true" default="http" doc="HTTP protocol (http or https)"
 * @/* Replaced /* Replaced /* Replaced guzzle */ */ */ base_url required="true" default="{{ protocol }}://{{ region }}/" doc="Amazon S3 endpoint"
 *
 * @/* Replaced /* Replaced /* Replaced guzzle */ */ */ cache.key_filter static="header=Date, Authorization; query=Timestamp, Signature"
 */
class S3Client extends AbstractClient
{
    ...
    /**
     * @var bool Force the /* Replaced /* Replaced /* Replaced client */ */ */ reference buckets using path hosting
     */
    ...
    /**
     * Check if the /* Replaced /* Replaced /* Replaced client */ */ */ is forcing path hosting buckets
     *
     * @return bool
     */
    ...
    /**
     * Set whether or not the /* Replaced /* Replaced /* Replaced client */ */ */ is forcing path hosting buckets
     *
    ...
    public function getRequest($httpMethod, $headers = null, $body = null)
    {
        ...
        $request->setHeader('Date', /* Replaced /* Replaced /* Replaced Guzzle */ */ */::getHttpDate('now'))
    ...
    public function getSignedUrl($bucket, $key, $duration, $cnamed = false, $torrent = false, $requesterPays = false)
    {
        ...
        $plugin = $this->getPlugin('/* Replaced /* Replaced /* Replaced Guzzle */ */ */\\Service\\Aws\\S3\\SignS3RequestPlugin');
