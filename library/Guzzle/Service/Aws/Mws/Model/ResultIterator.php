...
namespace /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Service\Aws\Mws\Model;

use /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Service\Aws\Mws\MwsClient;
use /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Service\Aws\Mws\Command\AbstractMwsCommand;
use /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Service\Aws\Mws\Command\IterableInterface;
...
class ResultIterator implements \Iterator
{
     ...
     * Initialize iterator
     *
     * @param MwsClient $/* Replaced /* Replaced /* Replaced client */ */ */
     * @param AbstractMwsCommand $command
     */
    public function __construct(MwsClient $/* Replaced /* Replaced /* Replaced client */ */ */, AbstractMwsCommand $command)
    {
    ...
    protected function loadResults()
    {
        ...
        $result = $this->/* Replaced /* Replaced /* Replaced client */ */ */->execute($this->command);
        $this->pages[$this->currentPage] = $this->parseResult($result);
        $this->hasNext = ($result->HasNext == 'true');

        $this->command = $this->/* Replaced /* Replaced /* Replaced client */ */ */->getCommand($this->nextCommandName)
