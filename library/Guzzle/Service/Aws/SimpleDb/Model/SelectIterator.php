...
namespace /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Service\Aws\SimpleDb\Model;
...
class SelectIterator extends ResourceIterator
{
     ...
     * result
     *
     * @param SimpleDbClient $/* Replaced /* Replaced /* Replaced client */ */ */ Client responsible for sending subsquent requests
     ...
     */
    public static function factory(SimpleDbClient $/* Replaced /* Replaced /* Replaced client */ */ */, \SimpleXMLElement $selectResult, array $data = array())
    {
        $result = self::processSelectResult($selectResult);
        
        return new self($/* Replaced /* Replaced /* Replaced client */ */ */, array_merge($data, array(
