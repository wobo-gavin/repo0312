...
use /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Service\Aws\SimpleDb\Model\SelectIterator;
 ...
 *
 * @/* Replaced /* Replaced /* Replaced guzzle */ */ */ select_expression required="true" doc="Select query expression"
 * @/* Replaced /* Replaced /* Replaced guzzle */ */ */ consistent_read doc="When set to true, ensures that the most recent data is returned"
 * @/* Replaced /* Replaced /* Replaced guzzle */ */ */ limit doc="Set a hard limit on the number of results to retrieve"
 * @/* Replaced /* Replaced /* Replaced guzzle */ */ */ next_token doc="Set the next token of the select query"
 */
class Select extends AbstractSimpleDbCommand
{
    ...
    protected function process()
    {
        ...
        if ($this->get('xml_only')) {
            ...
            $this->result = SelectIterator::factory($this->/* Replaced /* Replaced /* Replaced client */ */ */, $xml, array(
