...
use /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Service\CardinalCommerce\Centinel\CentinelErrorResponseException;
...
class Txn extends AbstractCommand
{
    ...
    protected function buildXml()
    {
        ...
        $queryString .= '<Version>' . $this->/* Replaced /* Replaced /* Replaced client */ */ */->getConfig('version') . '</Version>';
        $queryString .= '<ProcessorId>' . $this->/* Replaced /* Replaced /* Replaced client */ */ */->getConfig('processor_id') . '</ProcessorId>';
        $queryString .= '<MerchantId>' . $this->/* Replaced /* Replaced /* Replaced client */ */ */->getConfig('merchant_id') . '</MerchantId>';
        $queryString .= '<TransactionPwd>' . $this->/* Replaced /* Replaced /* Replaced client */ */ */->getConfig('password') . '</TransactionPwd>';

        // Add custom fields
        $queryString .= '<Source>PHPTC</Source>';
        $queryString .= '<SourceVersion>' . $this->/* Replaced /* Replaced /* Replaced client */ */ */->getConfig('version') . '</SourceVersion>';
        ...
        $queryString .= '<TransactionUrl>' . htmlentities($this->get('url', $this->/* Replaced /* Replaced /* Replaced client */ */ */->getBaseUrl())) . '</TransactionUrl>';
    ...
    {
        $this->request = $this->/* Replaced /* Replaced /* Replaced client */ */ */->getRequest(RequestInterface::POST);
