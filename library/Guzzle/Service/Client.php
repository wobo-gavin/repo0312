    ...
    public function getCommand($name, array $args = array())
    {
        if (!$this->commandFactory) {
            throw new ServiceException(
                'No command factory has been set on the /* Replaced /* Replaced /* Replaced client */ */ */.  A command ' .
                'factory is usually set on a /* Replaced /* Replaced /* Replaced client */ */ */ by a builder object.'
            );
        }
