...
class Client extends AbstractSubject
{
     ...
     *      /* Replaced /* Replaced /* Replaced client */ */ */ behaves and connects to a webservice.  Pass an array,
     *      Collection object or a string.  When passing a string, it will be
     *      treated as the base_url of the /* Replaced /* Replaced /* Replaced client */ */ */.
    ...
    public function getCommand($name, array $args = array())
    {
        if (!$this->commandFactory) {
            throw new ServiceException(
                'No command factory has been set on the /* Replaced /* Replaced /* Replaced client */ */ */'
            );
        }
