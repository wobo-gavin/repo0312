...
class Zend_Cache_Backend_Libmemcached extends Zend_Cache_Backend implements Zend_Cache_Backend_ExtendedInterface
{
     ...
     * =====> (array) /* Replaced /* Replaced /* Replaced client */ */ */ :
     * an array of memcached /* Replaced /* Replaced /* Replaced client */ */ */ options ; the memcached /* Replaced /* Replaced /* Replaced client */ */ */ is described by an associative array :
    ...
    protected $_options = array(
        ...
        '/* Replaced /* Replaced /* Replaced client */ */ */' => array()
    );
    ...
    public function __construct(array $options = array())
    {
        ...
        // override default /* Replaced /* Replaced /* Replaced client */ */ */ options
        $this->_options['/* Replaced /* Replaced /* Replaced client */ */ */'] = array(
        ...
        // setup memcached /* Replaced /* Replaced /* Replaced client */ */ */ options
        foreach ($this->_options['/* Replaced /* Replaced /* Replaced client */ */ */'] as $name => $value) {
            $optId = null;
            if (is_int($name)) {
                $optId = $name;
            } else {
                ...
                if (defined($optConst)) {
                    ...
                    $this->_log("Unknown memcached /* Replaced /* Replaced /* Replaced client */ */ */ option '{$name}' ({$optConst})");
                }
            }
            if ($optId) {
                if (!$this->_memcache->setOption($optId, $value)) {
                    $this->_log("Setting memcached /* Replaced /* Replaced /* Replaced client */ */ */ option '{$optId}' failed");
                }
            }
        }
