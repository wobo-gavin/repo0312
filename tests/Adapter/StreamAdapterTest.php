...
class StreamAdapterTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testThrowsExceptionsCaughtDuringTransfer()
    {
        ...
        $/* Replaced /* Replaced /* Replaced client */ */ */->get('http://localhost:123', [
            'timeout' => 0.01,
    ...
    public function testAutomaticallyDecompressGzip()
    {
        ...
        $body = $response->getBody();
        $this->assertEquals('/* Replaced /* Replaced /* Replaced guzzle */ */ */://stream', $body->getMetadata()['uri']);
    ...
    protected function getSendResult(array $opts)
    {
        ...
        return $/* Replaced /* Replaced /* Replaced client */ */ */->get(Server::$url, $opts);
    }
    ...
    public function testDebugAttributeWritesStreamInfoToTempBufferByDefault()
    {
        ...
        $fp = fopen('php://temp', 'w');
        $/* Replaced /* Replaced /* Replaced client */ */ */->get('/', ['debug' => $fp]);
        fseek($fp, 0);
    ...
    /**
     * @ticket https://github.com//* Replaced /* Replaced /* Replaced guzzle */ */ *///* Replaced /* Replaced /* Replaced guzzle */ */ *//issues/725
     */
    ...
    public function testDoesNotAddContentTypeByDefault()
    {
        ...
        $/* Replaced /* Replaced /* Replaced client */ */ */->put('/', ['body' => 'foo']);
