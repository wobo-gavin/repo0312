...
namespace /* Replaced /* Replaced /* Replaced Guzzle */ */ */Http\Tests\Subscriber\RetrySubscriber;
...
use /* Replaced /* Replaced /* Replaced Guzzle */ */ */Http\Subscriber\Log\SimpleLogger;
use /* Replaced /* Replaced /* Replaced Guzzle */ */ */Http\Subscriber\Retry\RetrySubscriber;
...
class RetrySubscriberTest extends \PHPUnit_Framework_TestCase
{
    ...
    private function createEvent(
        ...
        array $transferInfo = [],
        $type = '/* Replaced /* Replaced /* Replaced Guzzle */ */ */Http\Event\AbstractTransferStatsEvent'
    ) {
        if (!$request) {
