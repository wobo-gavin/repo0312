...
class MiddlewareTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testTapsBeforeAndAfter()
    {
        ...
        $this->assertInstanceOf('/* Replaced /* Replaced /* Replaced Guzzle */ */ */Http\ResponsePromiseInterface', $p);
    }
    ...
    public function testRetriesWhenDeciderReturnsTrue()
    {
        ...
        $this->assertInstanceOf('/* Replaced /* Replaced /* Replaced Guzzle */ */ */Http\FulfilledResponse', $p);
