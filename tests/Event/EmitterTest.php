...
use /* Replaced /* Replaced /* Replaced Guzzle */ */ */Http\Event\EventInterface;
...
class EmitterTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testDispatch()
    {
        ...
        $this->assertInstanceOf('/* Replaced /* Replaced /* Replaced Guzzle */ */ */Http\Event\EventInterface', $this->emitter->emit(self::preFoo, $this->getEvent()));
        $event = $this->getEvent();
    ...
    public function testAddSubscriberWithPriorities()
    {
        ...
        $this->assertNotEmpty($this->emitter->listeners(self::preFoo));
        $this->assertCount(2, $listeners);
        $this->assertInstanceOf('/* Replaced /* Replaced /* Replaced Guzzle */ */ */Http\Tests\Event\TestEventSubscriberWithPriorities', $listeners[0][0]);
    }
