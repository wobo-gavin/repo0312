...
class HandlerStackTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testCanPrintMiddleware()
    {
        ...
        $this->assertContains("1) Function: callable(/* Replaced /* Replaced /* Replaced Guzzle */ */ */Http\\Tests\\HandlerStackTest::foo)", $lines[1]);
        $this->assertContains("2) Function: callable(['/* Replaced /* Replaced /* Replaced Guzzle */ */ */Http\\Tests\\HandlerStackTest', 'bar'])", $lines[2]);
        $this->assertContains("3) Function: callable(/* Replaced /* Replaced /* Replaced Guzzle */ */ */Http\\Tests\\HandlerStackTest::foo)", $lines[3]);
