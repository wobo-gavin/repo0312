...
class HandlerStackTest extends TestCase
{
    ...
    public function testCanPrintMiddleware()
    {
        ...
        self::assertContains("> 3) Name: '', Function: callable(/* Replaced /* Replaced /* Replaced Guzzle */ */ */Http\\Tests\\HandlerStackTest::foo)", $lines[1]);
        self::assertContains("> 2) Name: '', Function: callable(['/* Replaced /* Replaced /* Replaced Guzzle */ */ */Http\\Tests\\HandlerStackTest', 'bar'])", $lines[2]);
        self::assertContains("> 1) Name: '', Function: callable(/* Replaced /* Replaced /* Replaced Guzzle */ */ */Http\\Tests\\HandlerStackTest::foo)", $lines[3]);
        self::assertContains("< 0) Handler: callable(", $lines[4]);
        self::assertContains("< 1) Name: '', Function: callable(/* Replaced /* Replaced /* Replaced Guzzle */ */ */Http\\Tests\\HandlerStackTest::foo)", $lines[5]);
        self::assertContains("< 2) Name: '', Function: callable(['/* Replaced /* Replaced /* Replaced Guzzle */ */ */Http\\Tests\\HandlerStackTest', 'bar'])", $lines[6]);
        self::assertContains("< 3) Name: '', Function: callable(/* Replaced /* Replaced /* Replaced Guzzle */ */ */Http\\Tests\\HandlerStackTest::foo)", $lines[7]);
