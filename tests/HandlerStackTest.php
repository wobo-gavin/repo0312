...
class HandlerStackTest extends TestCase
{
    ...
    public function testCanPrintMiddleware()
    {
        ...
        $this->assertContains("> 3) Name: '', Function: callable(/* Replaced /* Replaced /* Replaced Guzzle */ */ */Http\\Tests\\HandlerStackTest::foo)", $lines[1]);
        $this->assertContains("> 2) Name: '', Function: callable(['/* Replaced /* Replaced /* Replaced Guzzle */ */ */Http\\Tests\\HandlerStackTest', 'bar'])", $lines[2]);
        $this->assertContains("> 1) Name: '', Function: callable(/* Replaced /* Replaced /* Replaced Guzzle */ */ */Http\\Tests\\HandlerStackTest::foo)", $lines[3]);
        $this->assertContains("< 0) Handler: callable(", $lines[4]);
        $this->assertContains("< 1) Name: '', Function: callable(/* Replaced /* Replaced /* Replaced Guzzle */ */ */Http\\Tests\\HandlerStackTest::foo)", $lines[5]);
        $this->assertContains("< 2) Name: '', Function: callable(['/* Replaced /* Replaced /* Replaced Guzzle */ */ */Http\\Tests\\HandlerStackTest', 'bar'])", $lines[6]);
        $this->assertContains("< 3) Name: '', Function: callable(/* Replaced /* Replaced /* Replaced Guzzle */ */ */Http\\Tests\\HandlerStackTest::foo)", $lines[7]);
