...
class ClientTest extends TestCase
{
    ...
    public function testClientHasOptions()
    {
        ...
        $this->assertSame(2, $/* Replaced /* Replaced /* Replaced client */ */ */->getConfig('timeout'));
    ...
    public function testCanUseRelativeUriWithSend()
    {
        ...
        $this->assertSame('http://bar.com', (string) $/* Replaced /* Replaced /* Replaced client */ */ */->getConfig('base_uri'));
