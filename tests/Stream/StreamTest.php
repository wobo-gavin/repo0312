...
/**
 * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */Http\Stream\Stream
 */
class StreamTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testCreatesFromString()
    {
        ...
        $this->assertInstanceOf('/* Replaced /* Replaced /* Replaced Guzzle */ */ */Http\Stream\Stream', $stream);
    ...
    {
        $s = Stream::factory();
        $this->assertInstanceOf('/* Replaced /* Replaced /* Replaced Guzzle */ */ */Http\Stream\Stream', $s);
    ...
    {
        $s = $this->getMockBuilder('/* Replaced /* Replaced /* Replaced Guzzle */ */ */Http\Stream\Stream')
            ->setMethods(['read', 'eof'])
