...
class Server
{
    ...
    public static function enqueue($responses)
    {
        ...
        self::getClient()->put('/* Replaced /* Replaced /* Replaced guzzle */ */ */-server/responses', [
    ...
    public static function received($hydrate = false)
    {
        ...
        $response = self::getClient()->get('/* Replaced /* Replaced /* Replaced guzzle */ */ */-server/requests');
    ...
    {
        if (self::$started) {
            self::getClient()->delete('/* Replaced /* Replaced /* Replaced guzzle */ */ */-server');
        }
    ...
    {
        try {
            self::getClient()->get('/* Replaced /* Replaced /* Replaced guzzle */ */ */-server/perf', [
                'connect_timeout' => 5,
                'timeout'         => 5
            ]);
            return true;
    ...
    private static function getClient()
    {
        if (!self::$/* Replaced /* Replaced /* Replaced client */ */ */) {
            self::$/* Replaced /* Replaced /* Replaced client */ */ */ = new Client(['base_url' => self::$url]);
        }
