...
/**
 * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Http\CachingEntityBody
 */
class CachingEntityBodyTest extends \/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Tests\/* Replaced /* Replaced /* Replaced Guzzle */ */ */TestCase
{
    ...
    public function testRewindUsesSeek()
    {
        ...
        $d = $this->getMockBuilder('/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Http\CachingEntityBody')
    ...
    {
        $a = $this->getMockBuilder('/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Http\EntityBody')
