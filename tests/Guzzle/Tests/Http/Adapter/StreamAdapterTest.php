...
class StreamAdapterTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testReturnsResponseForSuccessfulRequest()
    {
        ...
        $response = $/* Replaced /* Replaced /* Replaced client */ */ */->get('/', ['Foo' => 'Bar']);
    ...
    public function testEmitsAfterSendEvent()
    {
        ...
        $this->assertInstanceOf('/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Http\Event\RequestAfterSendEvent', $ee);
    ...
    public function testStreamAttributeKeepsStreamOpen()
    {
        ...
        $response = $/* Replaced /* Replaced /* Replaced client */ */ */->put('/foo', ['Foo' => 'Bar'], 'test', ['stream' => true]);
        $this->assertEquals(200, $response->getStatusCode());
        $this->assertEquals('OK', $response->getReasonPhrase());
    ...
    public function testAddsGzipFilterIfAcceptHeaderIsPresent()
    {
        ...
        $response = $/* Replaced /* Replaced /* Replaced client */ */ */->get('/', ['Accept-Encoding' => 'gzip'], ['stream' => true]);
        $body = $response->getBody();
    ...
    {
        $path = __DIR__ . '/../../../../../src//* Replaced /* Replaced /* Replaced Guzzle */ */ *//Http/Resources/cacert.pem';
