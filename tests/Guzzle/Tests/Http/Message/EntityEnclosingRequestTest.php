...
class EntityEnclosingRequestTest extends \/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Tests\/* Replaced /* Replaced /* Replaced Guzzle */ */ */TestCase
{
    ...
    {
        $request = $this->factory->newRequest('PUT', 'http://www./* Replaced /* Replaced /* Replaced guzzle */ */ */-project.com/', null, 'data');
        ...
        $request = $this->factory->newRequest('POST', 'http://www./* Replaced /* Replaced /* Replaced guzzle */ */ */-project.com/', null, array(
            'data' => '123'
        ));
    ...
    /**
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Http\Message\EntityEnclosingRequest::process
     */
     ...
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Http\Message\EntityEnclosingRequest::addChain
     */
    public function testSetPostFields()
    {
        $request = $this->factory->newRequest('POST', 'http://www./* Replaced /* Replaced /* Replaced guzzle */ */ */-project.com/');
