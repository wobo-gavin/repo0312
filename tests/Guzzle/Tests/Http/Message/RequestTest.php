...
class RequestTest extends \/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Tests\/* Replaced /* Replaced /* Replaced Guzzle */ */ */TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->request = $this->/* Replaced /* Replaced /* Replaced client */ */ */->get();
    }

    public function tearDown()
    {
        unset($this->request);
        unset($this->/* Replaced /* Replaced /* Replaced client */ */ */);
    }
    ...
    public function testConstructorBuildsRequestWithArrayHeaders()
    {
        ...
        $this->assertEquals('http://www./* Replaced /* Replaced /* Replaced guzzle */ */ */-project.com/', $request->getUrl());
        $this->assertEquals('bar', $request->getHeader('foo'));
    }

    /**
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Http\Message\Request::getAllEvents
     */
    ...
    {
        $request = new Request('GET', 'http://www./* Replaced /* Replaced /* Replaced guzzle */ */ */-project.com/', new Collection(array(
            'foo' => 'bar'
        )));
        $this->assertEquals('bar', $request->getHeader('foo'));
    }
    ...
    {
        $request = new Request('GET', 'http://www./* Replaced /* Replaced /* Replaced guzzle */ */ */-project.com/', null);
    ...
    /**
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Http\Message\Request::getEventDispatcher
     */
    ...
    /**
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Http\Message\Request::getClient
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Http\Message\Request::setClient
     */
    public function testRequestsManageClients()
    {
        ...
        $this->assertSame($this->/* Replaced /* Replaced /* Replaced client */ */ */, $request->getClient());
    }
    ...
    /**
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Http\Message\Request::send
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Http\Message\Request::getResponse
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Http\Message\Request::setResponse
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Http\Message\Request::processResponse
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Http\Message\Request::getResponseBody
     */
    public function testSend()
    {
        ...
        $this->assertInstanceOf('/* Replaced /* Replaced /* Replaced Guzzle */ */ */\\Http\\Message\\Response', $this->request->getResponse());
    ...
    public function testRequestThrowsExceptionOnBadResponse()
    {
        try {
            ...
            $this->assertInstanceOf('/* Replaced /* Replaced /* Replaced Guzzle */ */ */\\Http\\Message\\Response', $e->getResponse());
            $this->assertContains('Client error response', $e->getMessage());
        }
    }

    /**
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Http\Message\Request::getQuery
     */
    public function testManagesQuery()
    {
        $this->assertInstanceOf('/* Replaced /* Replaced /* Replaced Guzzle */ */ */\\Http\\QueryString', $this->request->getQuery());
        $this->request->getQuery()->set('test', '123');
        $this->assertEquals('test=123', $this->request->getQuery(true));
    }

    /**
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Http\Message\Request::getMethod
     */
    ...
    /**
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Http\Message\Request::getScheme
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Http\Message\Request::setScheme
     */
    ...
    /**
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Http\Message\Request::getHost
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Http\Message\Request::setHost
     */
    ...
    /**
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Http\Message\Request::getProtocolVersion
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Http\Message\Request::setProtocolVersion
     */
    ...
    /**
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Http\Message\Request::getPath
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Http\Message\Request::setPath
     */
    ...
    /**
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Http\Message\Request::getPort
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Http\Message\Request::setPort
     */
    ...
    /**
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Http\Message\Request::getUsername
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Http\Message\Request::getPassword
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Http\Message\Request::setAuth
     */
    ...
    /**
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Http\Message\Request::getResource
     */
    ...
    /**
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Http\Message\Request::getUrl
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Http\Message\Request::setUrl
     */
    ...
    /**
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Http\Message\Request::setState
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Http\Message\Request::getState
     */
    ...
    /**
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Http\Message\Request::setResponseBody
     */
    ...
    /**
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Http\Message\Request::isResponseBodyRepeatable
     */
    ...
    /**
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Http\Message\Request::canCache
     */
    ...
    /**
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Http\Message\Request::__clone
     */
    ...
    /**
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Http\Message\Request::changedHeader
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Http\Message\Request::setHeader
     */
    ...
    /**
     * This test launches a dummy /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Http\Server\Server object that listens
    ...
    public function testRequestCanBeSentUsingCurl()
    {
        ...
        $userAgent = $this->/* Replaced /* Replaced /* Replaced client */ */ */->getDefaultUserAgent();
    ...
    /**
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Http\Message\Request::onRequestError
     */
    public function testThrowsExceptionsWhenUnsuccessfulResponseIsReceivedByDefault()
    {
        ...
        try {
            $request = $this->/* Replaced /* Replaced /* Replaced client */ */ */->get('/index.html');
            $response = $request->send();
            $this->fail('Request did not receive a 404 response');
        } catch (BadResponseException $e) {
            $this->assertContains('Client error response', $e->getMessage());
    ...
    public function testCanSendCustomRequests()
    {
        $this->getServer()->flush();
        $this->getServer()->enqueue("HTTP/1.1 200 OK\r\nContent-Length: 0\r\n\r\n");
        $request = $this->/* Replaced /* Replaced /* Replaced client */ */ */->createRequest('PROPFIND', $this->getServer()->getUrl(), array(
    ...
    public function testEnsuresFileCanBeCreated()
    {
        $this->getServer()->flush();
        $this->getServer()->enqueue("HTTP/1.1 200 OK\r\nContent-Length: 4\r\n\r\ntest");
        $this->/* Replaced /* Replaced /* Replaced client */ */ */->get('/')->setResponseBody('/wefwefefefefwewefwe/wefwefwefefwe/wefwefewfw.txt')->send();
    }
    ...
    public function testAllowsFilenameForDownloadingContent()
    {
        ...
        $this->/* Replaced /* Replaced /* Replaced client */ */ */->get('/')->setResponseBody($name)->send();
    ...
    public function testDoesNotUseRequestResponseBodyWhenNotCustom()
    {
        ...
        $response = $this->/* Replaced /* Replaced /* Replaced client */ */ */->get()->send();
