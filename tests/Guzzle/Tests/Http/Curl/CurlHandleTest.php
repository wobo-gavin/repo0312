...
class CurlHandleTest extends \/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Tests\/* Replaced /* Replaced /* Replaced Guzzle */ */ */TestCase
{
    ...
    public function testCurlFollowsRedirectsUsingStringBody(
        ...
        $/* Replaced /* Replaced /* Replaced client */ */ */ = new Client($url);
        $request = $/* Replaced /* Replaced /* Replaced client */ */ */->createRequest($method, '/test', $headers, '{}');
    ...
    /**
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Http\Curl\CurlHandle::parseCurlConfig
    ...
    public function testRedirectsPostWithGet($code, $forcePost = false, $method)
    {
        ...
        $/* Replaced /* Replaced /* Replaced client */ */ */ = new Client($this->getServer()->getUrl());
        $request = $/* Replaced /* Replaced /* Replaced client */ */ */->post('/', null, array('foo' => 'bar'));
        if ($forcePost !== false) {
    ...
    public function testAllowsCurloptEncodingToBeSet()
    {
        ...
        $/* Replaced /* Replaced /* Replaced client */ */ */ = new Client($this->getServer()->getUrl());
        $request = $/* Replaced /* Replaced /* Replaced client */ */ */->get('/', null, 'test');
