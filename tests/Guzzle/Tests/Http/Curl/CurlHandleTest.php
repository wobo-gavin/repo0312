...
class CurlHandleTest extends \/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Tests\/* Replaced /* Replaced /* Replaced Guzzle */ */ */TestCase
{
    ...
    public function dataProvider()
    {
        ...
        return array(
            ...
            array('GET', 'http://www./* Replaced /* Replaced /* Replaced guzzle */ */ */-project.com:8080/', array(
                ...
                CURLOPT_NOPROGRESS => 0,
                CURLOPT_ENCODING => '',
                CURLOPT_HTTPHEADER => array('Host: www./* Replaced /* Replaced /* Replaced guzzle */ */ */-project.com:8080', 'X-Test-Data: /* Replaced /* Replaced /* Replaced Guzzle */ */ */', 'User-Agent: ' . $userAgent),
                CURLOPT_PORT => 8080
            )),
    ...
    {
        $request = RequestFactory::create('GET', 'http://www./* Replaced /* Replaced /* Replaced guzzle */ */ */-project.com/');
