...
use /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Http\Curl\CurlFactory;
 ...
 * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Http\Curl\CurlFactory
 */
class CurlFactoryTest extends \/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Tests\/* Replaced /* Replaced /* Replaced Guzzle */ */ */TestCase
{
    /**
    ...
    public function dataProvider()
    {
        ...
        return array(
            ...
            array('GET', 'https://michael:123@www./* Replaced /* Replaced /* Replaced guzzle */ */ */-project.com/index.html?q=2', null, null, array(
                CURLOPT_RETURNTRANSFER => 0,
                CURLOPT_HEADER => 0,
                CURLOPT_FOLLOWLOCATION => 1,
                CURLOPT_MAXREDIRS => 5,
                ...
                CURLOPT_NOPROGRESS => 0,
                CURLOPT_ENCODING => '',
                CURLOPT_HTTPHEADER => array('User-Agent: ' . $userAgent, 'Host: www./* Replaced /* Replaced /* Replaced guzzle */ */ */-project.com', 'Authorization: Basic ' . $auth),
                CURLOPT_PORT => 443
            )),
            array('GET', 'http://www./* Replaced /* Replaced /* Replaced guzzle */ */ */-project.com:8080/', array(
                ...
                CURLOPT_NOPROGRESS => 0,
                CURLOPT_ENCODING => '',
                CURLOPT_HTTPHEADER => array('X-Test-Data: /* Replaced /* Replaced /* Replaced Guzzle */ */ */', 'User-Agent: ' . $userAgent, 'Host: www./* Replaced /* Replaced /* Replaced guzzle */ */ */-project.com:8080'),
                CURLOPT_PORT => 8080
            )),
            array('POST', 'http://www./* Replaced /* Replaced /* Replaced guzzle */ */ */-project.com/post.php', null, $qs, array(
                CURLOPT_RETURNTRANSFER => 0,
                CURLOPT_HEADER => 0,
                CURLOPT_FOLLOWLOCATION => 1,
                CURLOPT_MAXREDIRS => 5,
            ...
            array('PUT', 'http://www./* Replaced /* Replaced /* Replaced guzzle */ */ */-project.com/put.php', null, EntityBody::factory(fopen(__DIR__ . '/../../../../../phpunit.xml', 'r+')), array(
                CURLOPT_RETURNTRANSFER => 0,
                CURLOPT_HEADER => 0,
                CURLOPT_FOLLOWLOCATION => 1,
                CURLOPT_MAXREDIRS => 5,
            ...
            array('POST', 'http://www./* Replaced /* Replaced /* Replaced guzzle */ */ */-project.com/post.php', null, array(
                'a' => '2'
            ), array(
                CURLOPT_RETURNTRANSFER => 0,
                CURLOPT_HEADER => 0,
            ...
            array('POST', 'http://www./* Replaced /* Replaced /* Replaced guzzle */ */ */-project.com/post.php', null, $postBody, array(
                CURLOPT_RETURNTRANSFER => 0,
                CURLOPT_HEADER => 0,
                CURLOPT_FOLLOWLOCATION => 1,
                CURLOPT_MAXREDIRS => 5,
    ...
    {
        $request = RequestFactory::get('http://www./* Replaced /* Replaced /* Replaced guzzle */ */ */-project.com/');
    ...
    /**
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Http\Curl\CurlFactory
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Http\Curl\CurlFactory::getConnectionsPerHost
    ...
    /**
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Http\Curl\CurlFactory::setMaxIdleTime
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Http\Curl\CurlFactory::clean
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Http\Curl\CurlFactory::getConnectionsPerHost
     * @depends testReleasesAllHandles
     */
    ...
    /**
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Http\Curl\CurlFactory::setMaxConnectionReusesForHost
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Http\Curl\CurlFactory::clean
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Http\Curl\CurlFactory::createHandle
     */
