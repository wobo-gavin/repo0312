...
use /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Inflection\PreComputedInflector;

/**
 * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Inflection\PreComputedInflector
 */
class PreComputedInflectorTest extends \/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Tests\/* Replaced /* Replaced /* Replaced Guzzle */ */ */TestCase
{
    ...
    {
        $mock = $this->getMock('/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Inflection\Inflector', array('snake', 'camel'));
