...
class EmitterTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testDispatch()
    {
        ...
        $this->assertInstanceOf('/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Common\EventInterface', $this->emitter->emit(self::preFoo, new Event()));
        $event = new Event();
    ...
    public function testAddSubscriberWithPriorities()
    {
        ...
        $this->assertInstanceOf('/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Tests\Common\TestEventSubscriberWithPriorities', $listeners[0][0]);
    }
