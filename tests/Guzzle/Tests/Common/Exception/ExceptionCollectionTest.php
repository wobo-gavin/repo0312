...
class ExceptionCollectionTest extends \/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Tests\/* Replaced /* Replaced /* Replaced Guzzle */ */ */TestCase
{
    ...
    public function testAggregatesExceptions()
    {
        ...
        $e->add($exceptions[0]);
        $e->add($exceptions[1]);
        $this->assertContains("(Exception) ./tests//* Replaced /* Replaced /* Replaced Guzzle */ */ *//Tests/Common/Exception/ExceptionCollectionTest.php line ", $e->getMessage());
    ...
    public function testCanAddSelf()
    {
        ...
        $this->assertContains("(Exception) ./tests//* Replaced /* Replaced /* Replaced Guzzle */ */ *//Tests/Common/Exception/ExceptionCollectionTest.php line ", $message);
        $this->assertContains("\n    Test\n\n    #0 ", $message);
        $this->assertContains("\n\n(/* Replaced /* Replaced /* Replaced Guzzle */ */ */\\Common\\Exception\\ExceptionCollection) ./tests//* Replaced /* Replaced /* Replaced Guzzle */ */ *//Tests/Common/Exception/ExceptionCollectionTest.php line ", $message);
        $this->assertContains("\n\n    Meta description!\n\n", $message);
        $this->assertContains("    (Exception) ./tests//* Replaced /* Replaced /* Replaced Guzzle */ */ *//Tests/Common/Exception/ExceptionCollectionTest.php line ", $message);
        $this->assertContains("\n        Test 2\n\n        #0 ", $message);
        $this->assertContains("        (Exception) ./tests//* Replaced /* Replaced /* Replaced Guzzle */ */ *//Tests/Common/Exception/ExceptionCollectionTest.php line ", $message);
