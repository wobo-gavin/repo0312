...
use \/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Tests\Common\Mock\MockObserver,
    \/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Tests\Common\Mock\MockSubject,
    \/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Common\Subject\Subject,
    \/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Common\Subject\SubjectMediator,
    \/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Common\Subject\Observer;

/**
 * @author Michael Dowling <michael@/* Replaced /* Replaced /* Replaced guzzle */ */ */php.org>
 */
class SubjectMediatorTest extends \/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Tests\/* Replaced /* Replaced /* Replaced Guzzle */ */ */TestCase implements Observer
{
    /**
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Common\Subject\SubjectMediator::attach
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Common\Subject\SubjectMediator::getAttached
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Common\Subject\SubjectMediator::__construct
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Common\Subject\SubjectMediator::getSubject
     */
    ...
    public function testGetAttachedByName()
    {
        ...
        $subject->attach($observer);
        $this->assertEquals(array($observer), $subject->getAttached());
        $this->assertEquals(array($observer), $subject->getAttached('/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Tests\Common\Mock\MockObserver'));
    }

    /**
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Common\Subject\SubjectMediator::detach
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Common\Subject\SubjectMediator::getAttached
     * @depends testAttach
     */
    ...
    /**
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Common\Subject\SubjectMediator::detachAll
     * @depends testAttach
     */
    ...
    /**
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Common\Subject\SubjectMediator::getState
     */
    ...
    /**
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Common\Subject\SubjectMediator::getContext
     */
    ...
    /**
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Common\Subject\SubjectMediator::hasObserver
     * @depends testAttach
     */
    public function testHasObserver()
    {
        ...
        $this->assertFalse($subject->hasObserver('/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Tests\Common\Mock\MockObserver'));
        $subject->attach($observer);
        $this->assertTrue($subject->hasObserver($observer));
        $this->assertTrue($subject->hasObserver('/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Tests\Common\Mock\MockObserver'));
    }

    /**
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Common\Subject\SubjectMediator::notify
     */
    ...
    /**
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Common\Subject\SubjectMediator::is
     */
    public function testIs()
    {
        $mock = new MockSubject();
        $subject = new SubjectMediator($mock);
        $this->assertTrue($subject->is('/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Tests\Common\Mock\MockSubject'));
