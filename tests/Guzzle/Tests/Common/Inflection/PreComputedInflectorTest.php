...
namespace /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Tests\Common\Inflection;

use /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Common\Inflection\PreComputedInflector;

/**
 * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Common\Inflection\PreComputedInflector
 */
class PreComputedInflectorTest extends \/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Tests\/* Replaced /* Replaced /* Replaced Guzzle */ */ */TestCase
{
    public function testUsesPreComputedHash()
    {
        $mock = $this->getMock('/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Common\Inflection\Inflector', array('snake', 'camel'));
