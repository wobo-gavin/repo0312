...
use /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Common\Validation\IsInstanceOf;
...
class IsInstanceOfTest extends Validation
{
    public function provider()
    {
        ...
        return array(
            ...
            array($c, new IsInstanceOf(), array('class' => '/* Replaced /* Replaced /* Replaced Guzzle */ */ */.Common.Validation.IsInstanceOf'), true, null),
