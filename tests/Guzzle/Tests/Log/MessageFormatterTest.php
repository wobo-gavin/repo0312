 ...
 */
class MessageFormatterTest extends \/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Tests\/* Replaced /* Replaced /* Replaced Guzzle */ */ */TestCase
{
    protected $request;
    protected $response;
    protected $handle;
    ...
    public function setUp()
    {
        ...
        $this->handle = $this->getMockBuilder('/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Http\Curl\CurlHandle')
