...
class CookieTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $m = new \ReflectionMethod('/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Plugin\Cookie\Cookie', 'getInvalidCharacters');
        $m->setAccessible(true);
        $p = new \ReflectionProperty('/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Plugin\Cookie\Cookie', 'invalidCharString');
