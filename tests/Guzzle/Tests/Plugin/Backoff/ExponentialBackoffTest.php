...
class ExponentialBackoffPluginTest extends \/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Tests\/* Replaced /* Replaced /* Replaced Guzzle */ */ */TestCase
{
    ...
    /**
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Plugin\BackoffPlugin::getAllEvents
     */
     ...
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Plugin\BackoffPlugin::__construct
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Plugin\BackoffPlugin::getFailureCodes
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Plugin\BackoffPlugin::getMaxRetries
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Plugin\BackoffPlugin::setMaxRetries
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Plugin\BackoffPlugin::setFailureCodes
     */
    ...
    /**
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Plugin\BackoffPlugin::calculateWait
     */
    ...
    /**
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Plugin\BackoffPlugin::onRequestSent
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Plugin\BackoffPlugin::onRequestPoll
    ...
    /**
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Plugin\Backoff\ExponentialBackoffPlugin::onRequestSent
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Plugin\Backoff\ExponentialBackoffPlugin::onRequestPoll
    ...
    /**
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Plugin\Backoff\ExponentialBackoffPlugin::getDefaultFailureCodes
     */
    ...
    /**
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Plugin\Backoff\ExponentialBackoffPlugin::__construct
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Plugin\Backoff\ExponentialBackoffPlugin::getDefaultFailureCodes
     */
    ...
    {
        $plugin = $this->getMock('/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Plugin\Backoff\ExponentialBackoffPlugin', array('retryRequest'));
    ...
    public function testAllowsCustomFailureMethodsToPuntToDefaultMethod()
    {
        ...
        $plugin = $this->getMockBuilder('/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Plugin\Backoff\ExponentialBackoffPlugin')
    ...
    protected function getMockEvent(RequestInterface $request)
    {
        ...
        $multi = $this->getMockBuilder('/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Http\Curl\CurlMulti')
