...
class BackoffPluginTest extends \/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Tests\/* Replaced /* Replaced /* Replaced Guzzle */ */ */TestCase implements EventSubscriberInterface
{
    ...
    public function testCreatesDefaultExponentialBackoffPlugin()
    {
        ...
        $this->assertInstanceOf('/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Plugin\Backoff\BackoffPlugin', $plugin);
    ...
    public function testDoesNotRetryUnlessStrategyReturnsNumber()
    {
        ...
        $mock = $this->getMockBuilder('/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Plugin\Backoff\BackoffStrategyInterface')
