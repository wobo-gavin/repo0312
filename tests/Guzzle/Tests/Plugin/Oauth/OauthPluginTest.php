...
namespace /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Tests\Plugin\Oauth;
...
/**
 * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Plugin\Oauth\OauthPlugin
 */
class OauthPluginTest extends \/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Tests\/* Replaced /* Replaced /* Replaced Guzzle */ */ */TestCase
{
    ...
    public function testSignsOauthRequests()
    {
        ...
        // in the Authorization header. However /* Replaced /* Replaced /* Replaced Guzzle */ */ */ does not do this, so we just perform a simple check
    ...
    public function testInvalidMethodException()
    {
        $this->setExpectedException(
            '/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Plugin\Oauth\Exception\InvalidMethodException'
        );
