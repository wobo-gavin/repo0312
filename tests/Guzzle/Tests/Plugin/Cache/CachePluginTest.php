...
class CachePluginTest extends \/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Tests\/* Replaced /* Replaced /* Replaced Guzzle */ */ */TestCase
{
    ...
    public function testInjectsSatisfiableResponses($debugHeaders, $response)
    {
        ...
        if (!$debugHeaders) {
            ...
            $this->assertEquals('HIT from /* Replaced /* Replaced /* Replaced Guzzle */ */ */Cache', $request->getResponse()->getHeader('X-Cache-Lookup', true));
            $this->assertEquals('HIT from /* Replaced /* Replaced /* Replaced Guzzle */ */ */Cache', $request->getResponse()->getHeader('X-Cache', true));
        }
    }
    ...
    public function testInjectsSatisfiableResponsesOnError($debugHeaders, $responseParts)
    {
        ...
        $this->assertSame(sprintf('%s /* Replaced /* Replaced /* Replaced Guzzle */ */ */Cache/%s', $request->getProtocolVersion(), Version::VERSION), $request->getHeader('Via', true));
        $this->assertSame(sprintf('%s /* Replaced /* Replaced /* Replaced Guzzle */ */ */Cache/%s', $request->getProtocolVersion(), Version::VERSION), $response->getHeader('Via', true));
        $this->assertTrue($request->getParams()->get('cache.lookup'));
        ...
        if (!$debugHeaders) {
            ...
            $this->assertEquals('HIT from /* Replaced /* Replaced /* Replaced Guzzle */ */ */Cache', $response->getHeader('X-Cache-Lookup', true));
            $this->assertEquals('HIT_ERROR from /* Replaced /* Replaced /* Replaced Guzzle */ */ */Cache', $response->getHeader('X-Cache', true));
        }
    }
