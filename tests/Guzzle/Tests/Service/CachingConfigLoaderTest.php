...
use /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Service\CachingConfigLoader;
use Doctrine\Common\Cache\ArrayCache;

/**
 * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Service\CachingConfigLoader
 */
class CachingConfigLoaderTest extends \/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Tests\/* Replaced /* Replaced /* Replaced Guzzle */ */ */TestCase
{
    public function testLoadsPhpFileIncludes()
    {
        $cache = new DoctrineCacheAdapter(new ArrayCache());
        $loader = $this->getMockBuilder('/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Service\ConfigLoaderInterface')
