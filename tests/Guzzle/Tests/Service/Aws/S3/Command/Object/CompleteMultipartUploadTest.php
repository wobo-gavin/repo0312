...
use /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Service\Aws\S3\Command\Object\CompleteMultipartUpload;

/**
 * @author Michael Dowling <michael@/* Replaced /* Replaced /* Replaced guzzle */ */ */php.org>
 */
class CompleteMultipartUploadTest extends \/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Tests\/* Replaced /* Replaced /* Replaced Guzzle */ */ */TestCase
{
    /**
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Service\Aws\S3\Command\Object\CompleteMultipartUpload
     */
    public function testComplete()
    {
        ...
        $this->setMockResponse($/* Replaced /* Replaced /* Replaced client */ */ */, 'CompleteMultipartUploadResponse');
    ...
    public function testCompleteFailed()
    {
        ...
        $/* Replaced /* Replaced /* Replaced client */ */ */ = $this->getServiceBuilder()->getClient('test.s3');
        $this->setMockResponse($/* Replaced /* Replaced /* Replaced client */ */ */, 'CompleteMultipartUploadBadResponse');
        $/* Replaced /* Replaced /* Replaced client */ */ */->execute($command);
    }
}