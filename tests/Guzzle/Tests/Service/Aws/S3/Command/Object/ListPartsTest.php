...
use /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Service\Aws\S3\Command\Object\ListParts;

/**
 * @author Michael Dowling <michael@/* Replaced /* Replaced /* Replaced guzzle */ */ */php.org>
 */
class ListPartsTest extends \/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Tests\/* Replaced /* Replaced /* Replaced Guzzle */ */ */TestCase
{
    /**
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Service\Aws\S3\Command\Object\ListParts
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Service\Aws\S3\Model\ListPartsIterator
     */
    public function testListParts()
    {
        ...
        $this->setMockResponse($/* Replaced /* Replaced /* Replaced client */ */ */, 'ListPartsResponse');
    ...
    public function testListPartsExhaustive()
    {
        ...
        $/* Replaced /* Replaced /* Replaced client */ */ */ = $this->getServiceBuilder()->getClient('test.s3');
        $this->setMockResponse($/* Replaced /* Replaced /* Replaced client */ */ */, array('ListPartsTruncatedResponse', 'ListPartsResponse'));
        $/* Replaced /* Replaced /* Replaced client */ */ */->execute($command);
