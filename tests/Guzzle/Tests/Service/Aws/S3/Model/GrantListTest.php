...
use /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Service\Aws\S3\Model\GrantList;
use /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Service\Aws\S3\S3Client;

/**
 * @author Michael Dowling <michael@/* Replaced /* Replaced /* Replaced guzzle */ */ */php.org>
 */
class GrantListTest extends \/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Tests\/* Replaced /* Replaced /* Replaced Guzzle */ */ */TestCase
{
    /**
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Service\Aws\S3\Model\GrantList::__construct
     */
    public function testCanBuildFromExisting()
    {
        $l = new GrantList(array(
            array(
                'type' => 'Group',
                'grantee' => \/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Service\Aws\S3\S3Client::GRANT_AUTH,
                'permission' => 'FULL_CONTROL'
            )
        ));

        $this->assertTrue($l->hasGrant('Group', \/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Service\Aws\S3\S3Client::GRANT_AUTH, 'FULL_CONTROL'));
    ...
    /**
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Service\Aws\S3\Model\GrantList
     */
    ...
    /**
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Service\Aws\S3\Model\GrantList::__toString
     */
