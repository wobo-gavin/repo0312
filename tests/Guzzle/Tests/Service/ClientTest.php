...
class ClientTest extends \/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Tests\/* Replaced /* Replaced /* Replaced Guzzle */ */ */TestCase
{
     ...
     *
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Service\Client::__construct
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Service\Client::setRequestFactory
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Service\Client::attachPlugin
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Service\Client::hasPlugin
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Service\Client::getPlugin
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Service\Client::getShortPluginName
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Service\Client::detachPlugin
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Service\Client::getRequest
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Http\Plugin\AbstractPlugin
    ...
    public function testClientHandlesPlugins()
    {
        ...
        $this->assertTrue($/* Replaced /* Replaced /* Replaced client */ */ */->hasPlugin($logPlugin));
        $this->assertTrue($/* Replaced /* Replaced /* Replaced client */ */ */->hasPlugin('LogPlugin'));
        $this->assertFalse($/* Replaced /* Replaced /* Replaced client */ */ */->hasPlugin('test'));

        // Make sure that we can get the log plugin by long or short name
        $this->assertSame($logPlugin, $/* Replaced /* Replaced /* Replaced client */ */ */->getPlugin('/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Http\Plugin\Log\LogPlugin'));
        $this->assertSame($logPlugin, $/* Replaced /* Replaced /* Replaced client */ */ */->getPlugin('LogPlugin'));

        // Create a new filter that will set a mock response on all requests
        $filter = new \/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Tests\Common\Mock\MockFilter(array(
        ...
        $/* Replaced /* Replaced /* Replaced client */ */ */->getCreateRequestChain()->addFilter($filter);
        ...
        $/* Replaced /* Replaced /* Replaced client */ */ */->detachPlugin($logPlugin);
        ...
        $/* Replaced /* Replaced /* Replaced client */ */ */->detachPlugin('SuperLogPlugin');
        $this->assertTrue($/* Replaced /* Replaced /* Replaced client */ */ */->hasPlugin($logPlugin));
    ...
    /**
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Service\Client::execute
     * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Service\Client::getCreateRequestChain
     */
    public function testExecutesCommandSets()
    {
        ...
        $/* Replaced /* Replaced /* Replaced client */ */ */->getCreateRequestChain()->addFilter(new \/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Tests\Common\Mock\MockFilter(array(
            'callback' => function($filter, $command) {
                $command->setResponse(new \/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Http\Message\Response(200));
            }
        )));
