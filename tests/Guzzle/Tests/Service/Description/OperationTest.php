...
/**
 * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Service\Description\Operation
 */
class OperationTest extends \/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Tests\/* Replaced /* Replaced /* Replaced Guzzle */ */ */TestCase
{
    ...
    public function testOperationIsDataObject()
    {
        ...
        $this->assertEquals('/* Replaced /* Replaced /* Replaced Guzzle */ */ */\\Service\\Command\\OperationCommand', $c->getClass());
    ...
    public function testAllowsConcreteCommands()
    {
        ...
        $this->assertEquals('/* Replaced /* Replaced /* Replaced Guzzle */ */ */\\Service\\Command\ClosureCommand', $c->getClass());
    }
    ...
    public function testBuildsParametersLazily()
    {
        ...
        $this->assertInstanceOf('/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Service\Description\Parameter', $command->getParam('test'));
    }
    ...
    public function testHasData()
    {
        ...
        $this->assertEquals(array(
            'parameters' => array(),
            'class'      => '/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Service\Command\OperationCommand',
    ...
    protected function getOperation()
    {
        return new Operation(array(
            ...
            'errorResponses' => array(
                array('code' => 503, 'reason' => 'InsufficientCapacity', 'class' => '/* Replaced /* Replaced /* Replaced Guzzle */ */ */\\Exception\\RuntimeException')
            )
        ));
    }
}
