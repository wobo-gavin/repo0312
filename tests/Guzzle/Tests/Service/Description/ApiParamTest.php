...
/**
 * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Service\Description\ApiParam
 */
class ApiParamTest extends \/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Tests\/* Replaced /* Replaced /* Replaced Guzzle */ */ */TestCase
{
    ...
    public function testAllowsNestedStructures()
    {
        ...
        $this->assertInstanceOf('/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Service\Description\ApiParam', $param->getStructure('foo'));
        ...
        $this->assertInstanceOf('/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Service\Description\ApiParam', $param->getStructure('bar'));
