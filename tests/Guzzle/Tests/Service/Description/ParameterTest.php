...
/**
 * @covers /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Service\Description\Parameter
 */
class ParameterTest extends \/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Tests\/* Replaced /* Replaced /* Replaced Guzzle */ */ */TestCase
{
    ...
    public function testAllowsNestedShape()
    {
        ...
        $this->assertInstanceOf('/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Service\Description\Parameter', $param->getProperty('foo'));
        ...
        $this->assertInstanceOf('/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Service\Description\Parameter', $param->getProperty('bar'));
    ...
    public function testAddsAdditionalProperties()
    {
        ...
        $this->assertInstanceOf('/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Service\Description\Parameter', $p->getAdditionalProperties());
    ...
    public function testAddsItems()
    {
        ...
        $this->assertInstanceOf('/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Service\Description\Parameter', $p->getItems());
        $out = $p->toArray();
