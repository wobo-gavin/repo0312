...
class ConcreteDescriptionBuilderTest extends \/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Tests\/* Replaced /* Replaced /* Replaced Guzzle */ */ */TestCase
{
    ...
    {
        $builder = new ConcreteDescriptionBuilder('/* Replaced /* Replaced /* Replaced Guzzle */ */ */\\Tests\\Service\\Mock\\MockClient');
        $desc = $builder->build();
        $this->assertEquals('Mock', $desc->getName());
        $this->assertEquals('Mock /* Replaced /* Replaced /* Replaced Guzzle */ */ */ Service', $desc->getDescription());
        ...
        $this->assertInstanceOf('/* Replaced /* Replaced /* Replaced Guzzle */ */ */\\Service\\ApiCommand', $desc->getCommand('mock_command'));
