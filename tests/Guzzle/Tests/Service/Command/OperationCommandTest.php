 ...
 */
class OperationCommandTest extends \/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Tests\/* Replaced /* Replaced /* Replaced Guzzle */ */ */TestCase
{
    ...
    public function testPreparesRequestUsingSerializer()
    {
        ...
        $s = $this->getMockBuilder('/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Service\Command\RequestSerializerInterface')
    ...
    {
        $op = new OperationCommand(array(), new Operation());
        $p = $this->getMockBuilder('/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Service\Command\ResponseParserInterface')
