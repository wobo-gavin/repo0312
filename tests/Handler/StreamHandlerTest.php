...
class StreamHandlerTest extends TestCase
{
    ...
    public function testVerifyCanBeDisabled()
    {
        ...
        self::assertInstanceOf('/* Replaced /* Replaced /* Replaced Guzzle */ */ */Http\/* Replaced /* Replaced /* Replaced Psr7 */ */ */\Response', $handler);
    }
    ...
    {
        $path = $path = \/* Replaced /* Replaced /* Replaced Guzzle */ */ */Http\default_ca_bundle();
