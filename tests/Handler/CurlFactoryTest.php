...
use /* Replaced Guzzle */Http\Handler;
use /* Replaced Guzzle */Http\Handler\CurlFactory;
...
/**
 * @covers \/* Replaced Guzzle */Http\Handler\CurlFactory
 */
class CurlFactoryTest extends TestCase
{
    ...
    public function testCreatesCurlHandle()
    {
        Server::flush();
        Server::enqueue([
            new /* Replaced Psr7 */\Response(200, [
                'Foo' => 'Bar',
                'Baz' => 'bam',
                'Content-Length' => 2,
            ], 'hi')
        ...
        $request = new /* Replaced Psr7 */\Request('PUT', Server::$url, [
            'Hi'             => ' 123',
            'Content-Length' => '7'
        ], 'testing');
    ...
    {
        Server::flush();
        Server::enqueue([new /* Replaced Psr7 */\Response()]);
        $a = new Handler\CurlMultiHandler();
        $response = $a(new /* Replaced Psr7 */\Request('HEAD', Server::$url), []);
        $response->wait();
    ...
    public function testValidatesVerify()
    {
        ...
        $f->create(new /* Replaced Psr7 */\Request('GET', Server::$url), ['verify' => '/does/not/exist']);
    }

    public function testCanSetVerifyToFile()
    {
        $f = new Handler\CurlFactory(3);
        $f->create(new /* Replaced Psr7 */\Request('GET', 'http://foo.com'), ['verify' => __FILE__]);
    ...
    {
        $f = new Handler\CurlFactory(3);
        $f->create(new /* Replaced Psr7 */\Request('GET', 'http://foo.com'), ['verify' => __DIR__]);
    ...
    {
        $f = new Handler\CurlFactory(3);
        $f->create(new /* Replaced Psr7 */\Request('GET', Server::$url), ['verify' => true]);
        self::assertEquals(2, $_SERVER['_curl'][\CURLOPT_SSL_VERIFYHOST]);
        self::assertTrue($_SERVER['_curl'][\CURLOPT_SSL_VERIFYPEER]);
    ...
    {
        $f = new Handler\CurlFactory(3);
        $f->create(new /* Replaced Psr7 */\Request('GET', Server::$url), ['verify' => false]);
    ...
    {
        $f = new Handler\CurlFactory(3);
        $f->create(new /* Replaced Psr7 */\Request('GET', Server::$url), ['proxy' => 'http://bar.com']);
    ...
    {
        $f = new Handler\CurlFactory(3);
        $f->create(new /* Replaced Psr7 */\Request('GET', Server::$url), [
    ...
    {
        $f = new Handler\CurlFactory(3);
        $f->create(new /* Replaced Psr7 */\Request('GET', $url), [
            'proxy' => [
                'http' => 'http://bar.com',
                'https' => 'https://t',
                'no' => $noProxy
    ...
    public function testValidatesSslKey()
    {
        ...
        $f->create(new /* Replaced Psr7 */\Request('GET', Server::$url), ['ssl_key' => '/does/not/exist']);
    }

    public function testAddsSslKey()
    {
        $f = new Handler\CurlFactory(3);
        $f->create(new /* Replaced Psr7 */\Request('GET', Server::$url), ['ssl_key' => __FILE__]);
    ...
    {
        $f = new Handler\CurlFactory(3);
        $f->create(new /* Replaced Psr7 */\Request('GET', Server::$url), ['ssl_key' => [__FILE__, 'test']]);
        self::assertEquals(__FILE__, $_SERVER['_curl'][\CURLOPT_SSLKEY]);
    ...
    public function testValidatesCert()
    {
        ...
        $f->create(new /* Replaced Psr7 */\Request('GET', Server::$url), ['cert' => '/does/not/exist']);
    }

    public function testAddsCert()
    {
        $f = new Handler\CurlFactory(3);
        $f->create(new /* Replaced Psr7 */\Request('GET', Server::$url), ['cert' => __FILE__]);
    ...
    {
        $f = new Handler\CurlFactory(3);
        $f->create(new /* Replaced Psr7 */\Request('GET', Server::$url), ['cert' => [__FILE__, 'test']]);
        self::assertEquals(__FILE__, $_SERVER['_curl'][\CURLOPT_SSLCERT]);
    ...
    public function testValidatesProgress()
    {
        ...
        $this->expectException(\InvalidArgumentException::class);
        $this->expectExceptionMessage('progress /* Replaced client */ option must be callable');
        $f->create(new /* Replaced Psr7 */\Request('GET', Server::$url), ['progress' => 'foo']);
    }
    ...
    public function testEmitsDebugInfoToStream()
    {
        ...
        Server::enqueue([new /* Replaced Psr7 */\Response()]);
        $a = new Handler\CurlMultiHandler();
        $response = $a(new /* Replaced Psr7 */\Request('HEAD', Server::$url), ['debug' => $res]);
        $response->wait();
        \rewind($res);
    ...
    public function testEmitsProgressToFunction()
    {
        ...
        $a = new Handler\CurlMultiHandler();
        $called = [];
        $request = new /* Replaced Psr7 */\Request('HEAD', Server::$url);
        $response = $a($request, [
    ...
    private function addDecodeResponse($withEncoding = true)
    {
        ...
        $response = new /* Replaced Psr7 */\Response(200, $headers, $content);
        Server::flush();
    ...
    public function testDecodesGzippedResponses()
    {
        ...
        $request = new /* Replaced Psr7 */\Request('GET', Server::$url);
    ...
    public function testDecodesGzippedResponsesWithHeader()
    {
        $this->addDecodeResponse();
        $handler = new Handler\CurlMultiHandler();
        $request = new /* Replaced Psr7 */\Request('GET', Server::$url, ['Accept-Encoding' => 'gzip']);
        $response = $handler($request, ['decode_content' => true]);
        $response = $response->wait();
    ...
    /**
     * https://github.com//* Replaced guzzle *///* Replaced guzzle *//issues/2799
     */
    public function testDecodesGzippedResponsesWithHeaderForHeadRequest()
    {
        $this->addDecodeResponse();
        $handler = new Handler\CurlMultiHandler();
        $request = new /* Replaced Psr7 */\Request('HEAD', Server::$url, ['Accept-Encoding' => 'gzip']);
        $response = $handler($request, ['decode_content' => true]);
        $response = $response->wait();
        self::assertEquals('gzip', $_SERVER['_curl'][\CURLOPT_ENCODING]);
        $sent = Server::received()[0];
    ...
    public function testProtocolVersion()
    {
        ...
        Server::enqueue([new /* Replaced Psr7 */\Response()]);
        $a = new Handler\CurlMultiHandler();
        $request = new /* Replaced Psr7 */\Request('GET', Server::$url, [], null, '1.0');
        $a($request, []);
        self::assertEquals(\CURL_HTTP_VERSION_1_0, $_SERVER['_curl'][\CURLOPT_HTTP_VERSION]);
    }
    ...
    public function testSavesTo/* Replaced Guzzle */Stream()
    {
        $stream = /* Replaced Psr7 */\Utils::streamFor();
        $this->addDecodeResponse();
        $handler = new Handler\CurlMultiHandler();
    ...
    public function testDoesNotAddMultipleContentLengthHeaders()
    {
        $this->addDecodeResponse();
        $handler = new Handler\CurlMultiHandler();
        $request = new /* Replaced Psr7 */\Request('PUT', Server::$url, ['Content-Length' => 3], 'foo');
        $response = $handler($request, []);
        $response->wait();
        $sent = Server::received()[0];
    ...
    public function testSendsPostWithNoBodyOrDefaultContentType()
    {
        ...
        Server::enqueue([new /* Replaced Psr7 */\Response()]);
        $handler = new Handler\CurlMultiHandler();
        $request = new /* Replaced Psr7 */\Request('POST', Server::$url);
        $response = $handler($request, []);
        $response->wait();
    ...
    public function testFailsWhenCannotRewindRetryAfterNoResponse()
    {
        ...
        $stream = /* Replaced Psr7 */\Utils::streamFor('abc');
        $stream->read(1);
        $stream = new /* Replaced Psr7 */\NoSeekStream($stream);
        $request = new /* Replaced Psr7 */\Request('PUT', Server::$url, [], $stream);
    ...
    public function testRetriesWhenBodyCanBeRewound()
    {
        ...
        $fn = static function ($r, $options) use (&$callHandler) {
            $callHandler = true;
            return P\Create::promiseFor(new /* Replaced Psr7 */\Response());
        };

        $bd = /* Replaced Psr7 */\FnStream::decorate(/* Replaced Psr7 */\Utils::streamFor('test'), [
        ...
        $factory = new Handler\CurlFactory(1);
        $req = new /* Replaced Psr7 */\Request('PUT', Server::$url, [], $bd);
    ...
    public function testFailsWhenRetryMoreThanThreeTimes()
    {
        ...
        $p = $mock(new /* Replaced Psr7 */\Request('PUT', Server::$url, [], 'test'), []);
        $p->wait(false);
    ...
    public function testHandles100Continue()
    {
        Server::flush();
        Server::enqueue([
            new /* Replaced Psr7 */\Response(200, ['Test' => 'Hello', 'Content-Length' => 4], 'test'),
        ]);
        $request = new /* Replaced Psr7 */\Request('PUT', Server::$url, [
            'Expect' => '100-Continue'
        ], 'test');
    ...
    public function testCreatesConnectException()
    {
        ...
        $factory = new Handler\CurlFactory(1);
        $easy = $factory->create(new /* Replaced Psr7 */\Request('GET', Server::$url), []);
    ...
    {
        $f = new Handler\CurlFactory(3);
        $bd = /* Replaced Psr7 */\FnStream::decorate(/* Replaced Psr7 */\Utils::streamFor('foo'), [
            'getSize' => static function () {
                return null;
            }
        ]);
        $request = new /* Replaced Psr7 */\Request('PUT', Server::$url, [], $bd);
        $f->create($request, []);
    ...
    public function testRejectsPromiseWhenCreateResponseFails()
    {
        ...
        $this->expectException(\/* Replaced Guzzle */Http\Exception\RequestException::class);
    ...
    public function testRejectsPromiseWhenOnHeadersFails()
    {
        Server::flush();
        Server::enqueue([
            new /* Replaced Psr7 */\Response(200, ['X-Foo' => 'bar'], 'abc 123')
        ]);
        $req = new /* Replaced Psr7 */\Request('GET', Server::$url);
        $handler = new Handler\CurlHandler();
        $promise = $handler($req, [
    ...
    public function testSuccessfullyCallsOnHeadersBeforeWritingToSink()
    {
        ...
        $stream = /* Replaced Psr7 */\Utils::streamFor();
        $stream = /* Replaced Psr7 */\FnStream::decorate($stream, [
    ...
    {
        $body = /* Replaced Psr7 */\Utils::streamFor(\str_repeat('x', 1024 * 1024 * 2));
        $body->seek(1024 * 1024);
        self::assertSame(1024 * 1024, $body->tell());

        $req = new /* Replaced Psr7 */\Request('POST', 'https://www.example.com', [
    ...
    public function testDoesNotRewindUnseekableBody()
    {
        $body = /* Replaced Psr7 */\Utils::streamFor(\str_repeat('x', 1024 * 1024 * 2));
        $body->seek(1024 * 1024);
        $body = new /* Replaced Psr7 */\NoSeekStream($body);
        self::assertSame(1024 * 1024, $body->tell());
    ...
    /**
     * https://github.com//* Replaced guzzle *///* Replaced guzzle *//issues/2735
     */
