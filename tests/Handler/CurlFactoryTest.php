...
class CurlFactoryTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $f = new Handler\CurlFactory();
        $f(new /* Replaced /* Replaced /* Replaced Psr7 */ */ */\Request('GET', Server::$url), ['verify' => '/does/not/exist']);
    }

    public function testCanSetVerifyToFile()
    {
        $f = new Handler\CurlFactory();
        $f(new /* Replaced /* Replaced /* Replaced Psr7 */ */ */\Request('GET', 'http://foo.com'), ['verify' => __FILE__]);
    ...
    {
        $f = new Handler\CurlFactory();
        $f(new /* Replaced /* Replaced /* Replaced Psr7 */ */ */\Request('GET', Server::$url), ['verify' => true]);
        $this->assertEquals(2, $_SERVER['_curl'][CURLOPT_SSL_VERIFYHOST]);
        $this->assertEquals(true, $_SERVER['_curl'][CURLOPT_SSL_VERIFYPEER]);
    ...
    {
        $f = new Handler\CurlFactory();
        $f(new /* Replaced /* Replaced /* Replaced Psr7 */ */ */\Request('GET', Server::$url), ['verify' => false]);
    ...
    {
        $f = new Handler\CurlFactory();
        $f(new /* Replaced /* Replaced /* Replaced Psr7 */ */ */\Request('GET', Server::$url), ['proxy' => 'http://bar.com']);
    ...
    {
        $f = new Handler\CurlFactory();
        $f(new /* Replaced /* Replaced /* Replaced Psr7 */ */ */\Request('GET', Server::$url), [
    ...
    {
        $f = new Handler\CurlFactory();
        $f(new /* Replaced /* Replaced /* Replaced Psr7 */ */ */\Request('GET', Server::$url), ['ssl_key' => '/does/not/exist']);
    }

    public function testAddsSslKey()
    {
        $f = new Handler\CurlFactory();
        $f(new /* Replaced /* Replaced /* Replaced Psr7 */ */ */\Request('GET', Server::$url), ['ssl_key' => __FILE__]);
    ...
    {
        $f = new Handler\CurlFactory();
        $f(new /* Replaced /* Replaced /* Replaced Psr7 */ */ */\Request('GET', Server::$url), ['ssl_key' => [__FILE__, 'test']]);
        $this->assertEquals(__FILE__, $_SERVER['_curl'][CURLOPT_SSLKEY]);
    ...
    {
        $f = new Handler\CurlFactory();
        $f(new /* Replaced /* Replaced /* Replaced Psr7 */ */ */\Request('GET', Server::$url), ['cert' => '/does/not/exist']);
    }

    public function testAddsCert()
    {
        $f = new Handler\CurlFactory();
        $f(new /* Replaced /* Replaced /* Replaced Psr7 */ */ */\Request('GET', Server::$url), ['cert' => __FILE__]);
    ...
    {
        $f = new Handler\CurlFactory();
        $f(new /* Replaced /* Replaced /* Replaced Psr7 */ */ */\Request('GET', Server::$url), ['cert' => [__FILE__, 'test']]);
        $this->assertEquals(__FILE__, $_SERVER['_curl'][CURLOPT_SSLCERT]);
    ...
    /**
     * @expectedException \InvalidArgumentException
     * @expectedExceptionMessage progress /* Replaced /* Replaced /* Replaced client */ */ */ option must be callable
     */
    public function testValidatesProgress()
    {
        $f = new Handler\CurlFactory();
        $f(new /* Replaced /* Replaced /* Replaced Psr7 */ */ */\Request('GET', Server::$url), ['progress' => 'foo']);
    }
    ...
    {
        $req = new /* Replaced /* Replaced /* Replaced Psr7 */ */ */\Request('PUT', Server::$url, [], new /* Replaced /* Replaced /* Replaced Psr7 */ */ */\NoSeekStream(/* Replaced /* Replaced /* Replaced Psr7 */ */ */\stream_for()));
        $bd = /* Replaced /* Replaced /* Replaced Psr7 */ */ */\stream_for('');
        $fn = function () {};
    ...
    {
        $body = new /* Replaced /* Replaced /* Replaced Psr7 */ */ */\NoSeekStream(/* Replaced /* Replaced /* Replaced Psr7 */ */ */\stream_for('foo'));
        $req = new /* Replaced /* Replaced /* Replaced Psr7 */ */ */\Request('PUT', Server::$url, [], $body);
        $fn = function () {};
        $rbody = /* Replaced /* Replaced /* Replaced Psr7 */ */ */\stream_for();
    ...
    public function testRetriesWhenBodyCanBeRewound()
    {
        ...
        $fn = function ($r, $options) use (&$callHandler) {
            $callHandler = true;
            return \/* Replaced /* Replaced /* Replaced Guzzle */ */ */Http\Promise\promise_for(new /* Replaced /* Replaced /* Replaced Psr7 */ */ */\Response());
        };
        ...
        $rbd = /* Replaced /* Replaced /* Replaced Psr7 */ */ */\stream_for();
    ...
    {
        $m = new \ReflectionMethod('/* Replaced /* Replaced /* Replaced Guzzle */ */ */Http\Handler\CurlFactory', 'createErrorResponse');
        $m->setAccessible(true);
        $response = $m->invoke(
            null,
            function () {},
            new /* Replaced /* Replaced /* Replaced Psr7 */ */ */\Request('GET', Server::$url),
            [],
            [
                'err_message' => 'foo',
                'curl' => [
    ...
    {
        $f = new Handler\CurlFactory();
        $bd = /* Replaced /* Replaced /* Replaced Psr7 */ */ */\FnStream::decorate(/* Replaced /* Replaced /* Replaced Psr7 */ */ */\stream_for('foo'), [
            'getSize' => function () {
                return null;
            }
        ]);
