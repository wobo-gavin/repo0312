...
class FunctionsTest extends \PHPUnit_Framework_TestCase
{
    public function testRetrievesNestedKeysUsingPath()
    {
        ...
        $this->assertEquals('bar', /* Replaced /* Replaced /* Replaced Guzzle */ */ */Http\get_path($data, 'foo'));
        $this->assertEquals('jar', /* Replaced /* Replaced /* Replaced Guzzle */ */ */Http\get_path($data, 'baz/mesa/jar'));
        $this->assertNull(/* Replaced /* Replaced /* Replaced Guzzle */ */ */Http\get_path($data, 'wewewf'));
        $this->assertNull(/* Replaced /* Replaced /* Replaced Guzzle */ */ */Http\get_path($data, 'baz/mesa/jar/jar'));
    }

    public function testFalseyKeysStillDescend()
    {
        $data = ['0' => ['a' => 'jar'], 1 => 'other'];
        $this->assertEquals('jar', /* Replaced /* Replaced /* Replaced Guzzle */ */ */Http\get_path($data, '0/a'));
        $this->assertEquals('other', /* Replaced /* Replaced /* Replaced Guzzle */ */ */Http\get_path($data, '1'));
    }
    ...
    {
        $this->assertEquals($expected, /* Replaced /* Replaced /* Replaced Guzzle */ */ */Http\get_path($c, $path));
    }

    public function testCanSetNestedPathValueThatDoesNotExist()
    {
        $c = [];
        /* Replaced /* Replaced /* Replaced Guzzle */ */ */Http\set_path($c, 'foo/bar/baz/123', 'hi');
    ...
    {
        $c = ['foo' => ['bar' => 'test']];
        /* Replaced /* Replaced /* Replaced Guzzle */ */ */Http\set_path($c, 'foo/bar', 'hi');
    ...
    {
        $c = ['foo' => 'bar'];
        /* Replaced /* Replaced /* Replaced Guzzle */ */ */Http\set_path($c, 'foo/bar/baz', 'test');
    }

    public function testCanAppendToNestedPathValues()
    {
        $c = [];
        /* Replaced /* Replaced /* Replaced Guzzle */ */ */Http\set_path($c, 'foo/bar/[]', 'a');
        /* Replaced /* Replaced /* Replaced Guzzle */ */ */Http\set_path($c, 'foo/bar/[]', 'b');
    ...
    {
        $c = [];
        /* Replaced /* Replaced /* Replaced Guzzle */ */ */Http\set_path($c, 'foo', 'a');
    ...
    {
        $this->assertTrue(is_resource(/* Replaced /* Replaced /* Replaced Guzzle */ */ */Http\get_debug_resource()));
    }
