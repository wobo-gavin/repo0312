...
class Client implements ClientInterface
{
     ...
     *     - base_uri: Base URI of the /* Replaced /* Replaced /* Replaced client */ */ */ that is merged into relative URIs.
    ...
    public function __construct(array $config = [])
    {
        ...
        $this->handler = isset($config['handler'])
            ? $config['handler']
            : \/* Replaced /* Replaced /* Replaced Guzzle */ */ */Http\default_handler();
    }
    ...
    private function configureDefaults(array $config)
    {
        ...
        if (!isset($this->defaults['headers'])) {
            $this->defaults['headers'] = [
                'User-Agent' => \/* Replaced /* Replaced /* Replaced Guzzle */ */ */Http\default_user_agent()
            ];
        } else {
            ...
            $this->defaults['headers']['User-Agent'] = \/* Replaced /* Replaced /* Replaced Guzzle */ */ */Http\default_user_agent();
        }
    }
    ...
    private function applyOptions(RequestInterface $request, array &$options)
    {
        ...
        return \/* Replaced /* Replaced /* Replaced Guzzle */ */ */Http\modify_request($request, $modify);
    }
