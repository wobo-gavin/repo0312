...
class Client implements ClientInterface, \Psr\Http\Client\ClientInterface
{
    ...
    private function configureDefaults(array $config): void
    {
        ...
        if (PHP_SAPI === 'cli' && ($proxy = \/* Replaced /* Replaced /* Replaced Guzzle */ */ */Http\_getenv('HTTP_PROXY'))) {
            $defaults['proxy']['http'] = $proxy;
        }

        if ($proxy = \/* Replaced /* Replaced /* Replaced Guzzle */ */ */Http\_getenv('HTTPS_PROXY')) {
            $defaults['proxy']['https'] = $proxy;
        }

        if ($noProxy = \/* Replaced /* Replaced /* Replaced Guzzle */ */ */Http\_getenv('NO_PROXY')) {
