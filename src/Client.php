...
/**
 * /* Replaced /* Replaced /* Replaced Guzzle */ */ */Http /* Replaced /* Replaced /* Replaced client */ */ */ implementation.
 *
 *     $/* Replaced /* Replaced /* Replaced client */ */ */ = new /* Replaced /* Replaced /* Replaced Guzzle */ */ */Http\Client();
 *     $response = $/* Replaced /* Replaced /* Replaced client */ */ */->request('GET', 'http://www.google.com');
 *     $response->then(
 *         function ($response) {
 *             echo "Got a response: \n" . /* Replaced /* Replaced /* Replaced Guzzle */ */ */Http\str_message($response) . "\n";
 *         },
 *         function ($e) {
...
class Client implements ClientInterface
{
     ...
     *
     * - base_uri: (string) Base URI of the /* Replaced /* Replaced /* Replaced client */ */ */ that is merged into relative
     ...
     *   a PEM formatted SSL /* Replaced /* Replaced /* Replaced client */ */ */ side certificate. If a password is
     ...
     *   for a request.
     * - cookies: (bool|array|/* Replaced /* Replaced /* Replaced Guzzle */ */ */Http\Cookie\CookieJarInterface, default=false)
    ...
    private function buildUri($uri)
    {
        ...
        // Absolute URL
        if (strpos($uri[0], '://')) {
            return new /* Replaced /* Replaced /* Replaced Psr7 */ */ */\Uri(uri_template($uri[0], $uri[1]));
        }
    ...
    private function transfer(RequestInterface $request, array $options)
    {
        if (!isset($options['stack'])) {
            ...
            throw new \InvalidArgumentException('The stack option must be an instance of /* Replaced /* Replaced /* Replaced Guzzle */ */ */Http\\HandlerBuilder');
        }
        ...
        try {
            ...
            return \/* Replaced /* Replaced /* Replaced Guzzle */ */ */Http\Promise\promise_for($response);
        } catch (\Exception $e) {
