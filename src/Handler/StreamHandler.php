...
class StreamHandler
{
    ...
    private function createResponse(
        ...
        $stream = /* Replaced /* Replaced /* Replaced Psr7 */ */ */\stream_for($this->checkDecode($options, $headers, $stream));
        $sink = $this->createSink($stream, $options);
        $response = new /* Replaced /* Replaced /* Replaced Psr7 */ */ */\Response($status, $headers, $sink, $ver, $reason);
    ...
    /**
     * Drains the source stream into the "sink" /* Replaced /* Replaced /* Replaced client */ */ */ option.
     *
    ...
    {
        /* Replaced /* Replaced /* Replaced Psr7 */ */ */\copy_to_stream($source, $sink);
        $sink->seek(0);
        $source->close();
