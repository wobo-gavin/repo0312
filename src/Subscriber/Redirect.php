 ...
 *     redirect POST with POST) vs doing what most /* Replaced /* Replaced /* Replaced client */ */ */s do (e.g., redirect
...
class Redirect implements SubscriberInterface
{
     ...
     * with POST) vs doing what most /* Replaced /* Replaced /* Replaced client */ */ */s do (e.g. redirect POST with GET).
     *
