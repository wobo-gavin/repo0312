...
class CacheSubscriber implements SubscriberInterface
{
    ...
    public function onRequestBeforeSend(Event $event)
    {
        ...
        $request->addHeader('Via', sprintf('%s /* Replaced /* Replaced /* Replaced Guzzle */ */ */Cache/%s', $request->getProtocolVersion(), \/* Replaced /* Replaced /* Replaced Guzzle */ */ */Http\VERSION));
    ...
    {
        $params = $request->getParams();
        $response->setHeader('Via', sprintf('%s /* Replaced /* Replaced /* Replaced Guzzle */ */ */Cache/%s', $request->getProtocolVersion(), \/* Replaced /* Replaced /* Replaced Guzzle */ */ */Http\VERSION));
        ...
        if ($params['cache.hit'] === true) {
            $xcache = 'HIT from /* Replaced /* Replaced /* Replaced Guzzle */ */ */Cache';
        } elseif ($params['cache.hit'] == 'error') {
            $xcache = 'HIT_ERROR from /* Replaced /* Replaced /* Replaced Guzzle */ */ */Cache';
        } else {
            $xcache = 'MISS from /* Replaced /* Replaced /* Replaced Guzzle */ */ */Cache';
        }
        ...
        if ($response->isFresh() === false) {
            $response->addHeader('Warning', sprintf('110 /* Replaced /* Replaced /* Replaced Guzzle */ */ */Cache/%s "Response is stale"', \/* Replaced /* Replaced /* Replaced Guzzle */ */ */Http\VERSION));
            if ($params['cache.hit'] === 'error') {
                $response->addHeader('Warning', sprintf('111 /* Replaced /* Replaced /* Replaced Guzzle */ */ */Cache/%s "Revalidation failed"', \/* Replaced /* Replaced /* Replaced Guzzle */ */ */Http\VERSION));
            }
        }
    }
}
