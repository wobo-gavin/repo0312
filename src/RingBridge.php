...
class RingBridge
{
    ...
    public static function prepareRingRequest(Transaction $trans)
    {
        ...
        if ($trans->request->getEmitter()->hasListeners('progress')) {
            ...
            $request['/* Replaced /* Replaced /* Replaced client */ */ */']['progress'] = function ($a, $b, $c, $d) use ($trans, $emitter) {
...
then it is recommneded to use the /* Replaced /* Replaced /* Replaced Guzzle */ */ */Http\Ring\Client\MockHandler.
EOT;
