...
implemented /* Replaced /* Replaced /* Replaced Guzzle */ */ */-Ring adapter that is not calling the "then" function of a
request array when the response is ready. If you are simply trying to mock
responses, then it is recommneded to use the
/* Replaced /* Replaced /* Replaced Guzzle */ */ */Http\Ring\Client\MockAdapter.
EOT;
