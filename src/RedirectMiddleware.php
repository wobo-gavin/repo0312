...
class RedirectMiddleware
{
    ...
    public function checkRedirect(
        ...
        if (!empty($options['allow_redirects']['track_redirects'])) {
            ...
            if (!$response->hasHeader('X-/* Replaced /* Replaced /* Replaced Guzzle */ */ */-Redirect')) {
                $response = $response->withHeader('X-/* Replaced /* Replaced /* Replaced Guzzle */ */ */-Redirect', $options['_previous_uris']);
            }
        }
        return $response;
    }
