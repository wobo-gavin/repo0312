...
class BatchBuilder
{
    ...
    protected static $mapping = array(
        'request' => '/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Batch\BatchRequestTransfer',
        'command' => '/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Batch\BatchCommandTransfer'
    );
    ...
    /**
     * Configures the batch to transfer batches of requests. Associates a {@see \/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Http\BatchRequestTransfer}
     ...
     * {@see \/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Service\Command\BatchCommandTransfer} as both the transfer and divisor strategy.
     *
