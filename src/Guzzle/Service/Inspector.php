 ...
 *
 * The Reflection class can parse @/* Replaced /* Replaced /* Replaced guzzle */ */ */ specific parameters in a class's
 ...
 * annotation.
 *
 * The following is the format for @/* Replaced /* Replaced /* Replaced guzzle */ */ */ arguments:
 * @/* Replaced /* Replaced /* Replaced guzzle */ */ */ argument_name [default="default value"] [required="true|false"] [type="registered constraint name"] [type_args=""] [doc="Description of argument"]
 *
 * Here's an example:
 * @/* Replaced /* Replaced /* Replaced guzzle */ */ */ my_argument default="hello" required="true" doc="Set the argument to control the widget..."
 */
class Inspector
{
    ...
    {
        $base = '/* Replaced /* Replaced /* Replaced Guzzle */ */ */\\Common\\Validation\\';
    ...
    /**
     * Validate a constraint by name: e.g. "type:/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Common\Collection";
    ...
    /**
     * Get an array of ApiParam objects for a class using @/* Replaced /* Replaced /* Replaced guzzle */ */ */ annotations
     *
    ...
    /**
     * Get the /* Replaced /* Replaced /* Replaced Guzzle */ */ */ arguments from a DocBlock
     *
    ...
    {
        // Get all of the @/* Replaced /* Replaced /* Replaced guzzle */ */ */ annotations from the class
        $matches = array();
