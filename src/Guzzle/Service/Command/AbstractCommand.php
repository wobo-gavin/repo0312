...
abstract class AbstractCommand extends Collection implements CommandInterface
{
    ...
    public function getName()
    {
        if ($this->apiCommand) {
            ...
            // /* Replaced /* Replaced /* Replaced client */ */ */ that executes the command
            $parts = explode('\\', get_class($this));
            while (array_shift($parts) !== 'Command');

            return implode('.', array_map(array('/* Replaced /* Replaced /* Replaced Guzzle */ */ */\\Service\\Inflector', 'snake'), $parts));
        }
    }
