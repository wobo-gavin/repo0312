...
class ApiCommand
{
     ...
     */
    const DEFAULT_COMMAND_CLASS = '/* Replaced /* Replaced /* Replaced Guzzle */ */ */\\Service\\Command\\DynamicCommand';

    /**
     * @var string Annotation used to specify /* Replaced /* Replaced /* Replaced Guzzle */ */ */ service description info
     */
     ...
     * Example: @/* Replaced /* Replaced /* Replaced guzzle */ */ */ my_argument default="hello" required="true" doc="Set the argument to control the widget..."
     *
