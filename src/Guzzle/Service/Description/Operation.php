...
class Operation implements OperationInterface
{
     ...
     */
    const DEFAULT_COMMAND_CLASS = '/* Replaced /* Replaced /* Replaced Guzzle */ */ */\\Service\\Command\\OperationCommand';
     ...
     *                       documentation purposes. This prevents /* Replaced /* Replaced /* Replaced Guzzle */ */ */ from having to crawl and normalize the
     *                       response model.
     ...
     * '/* Replaced /* Replaced /* Replaced Guzzle */ */ */\\Foo\\Baz', or 'MyModelName' (to reference a model by ID).
     *
