...
class Client extends AbstractHasDispatcher implements ClientInterface
{
    ...
    /**
     * @var UriTemplate URI template owned by the /* Replaced /* Replaced /* Replaced client */ */ */
     */
    private $uriTemplate;
     ...
     *
     * @param array|Collection|string $config Parameters that define how the /* Replaced /* Replaced /* Replaced client */ */ */
     ...
     *                         to retrieve all values of the /* Replaced /* Replaced /* Replaced client */ */ */.  The
     *                         object return can be modified, and modifications
     *                         will affect the /* Replaced /* Replaced /* Replaced client */ */ */'s config.
     *
     ...
     * relative path to append to the base path of the /* Replaced /* Replaced /* Replaced client */ */ */.  The URI can
     ...
     *
     * @return Request
     * @see    /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Http\Client::createRequest()
     */
    ...
    /**
     * Get the curl multi object used with the /* Replaced /* Replaced /* Replaced client */ */ */
     *
