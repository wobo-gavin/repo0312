...
class Client extends AbstractHasDispatcher implements ClientInterface
{
     ...
     *      to override the base path of the /* Replaced /* Replaced /* Replaced client */ */ */, or a relative path to
     *      append to the base path of the /* Replaced /* Replaced /* Replaced client */ */ */.  The URI can contain the
     ...
     *    /* Replaced /* Replaced /* Replaced Guzzle */ */ */ user agent
     *
     * @return Client
     */
    public function setUserAgent($userAgent, $includeDefault = false)
    {
        ...
        if ($includeDefault) {
            $this->userAgent .= ' ' . /* Replaced /* Replaced /* Replaced Guzzle */ */ */::getDefaultUserAgent();
        }
