 ...
 *   strict RFC compliant redirection (e.g. redirect POST with POST) vs doing what most /* Replaced /* Replaced /* Replaced client */ */ */s do (e.g. redirect
...
class Redirect implements EventSubscriberInterface
{
     ...
     *
     * Takes into account strict RFC compliant redirection (e.g. redirect POST with POST) vs doing what most /* Replaced /* Replaced /* Replaced client */ */ */s do
