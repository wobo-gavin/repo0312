...
class Response extends AbstractMessage
{
     ...
     *
     * @return Header|null Returns a Header object that tells all caching mechanisms from server to /* Replaced /* Replaced /* Replaced client */ */ */ whether they
     ...
     *
     * @return int|null If an entity is temporarily unavailable, this instructs the /* Replaced /* Replaced /* Replaced client */ */ */ to try again after a
     ...
     *
     * @return string|null Informs the /* Replaced /* Replaced /* Replaced client */ */ */ of proxies through which the response was sent.
