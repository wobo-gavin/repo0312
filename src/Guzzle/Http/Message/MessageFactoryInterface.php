...
interface MessageFactoryInterface
{
     ...
     *       {@see /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Http\Subscriber\CookieJar\CookieJarInterface} object to us an exisitng cookie jar, or set
     *       to `true` to use the shared cookie session of the /* Replaced /* Replaced /* Replaced client */ */ */.
