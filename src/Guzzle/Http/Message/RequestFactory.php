...
class RequestFactory implements RequestFactoryInterface
{
    ...
    protected $requestClass = '/* Replaced /* Replaced /* Replaced Guzzle */ */ */\\Http\\Message\\Request';

    /** @var string Class to instantiate for requests with a body */
    protected $entityEnclosingRequestClass = '/* Replaced /* Replaced /* Replaced Guzzle */ */ */\\Http\\Message\\EntityEnclosingRequest';
    ...
    {
        // Create the request with the same /* Replaced /* Replaced /* Replaced client */ */ */ if possible
        if ($/* Replaced /* Replaced /* Replaced client */ */ */ = $request->getClient()) {
    ...
    protected function visit_exceptions(RequestInterface $request, $value, $flags)
    {
        if ($value === false || $value === 0) {
            ...
            foreach ($dispatcher->getListeners('request.error') as $listener) {
                if (is_array($listener) && $listener[0] == '/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Http\Message\Request' && $listener[1] = 'onRequestError') {
