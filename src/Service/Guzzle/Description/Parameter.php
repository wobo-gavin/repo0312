...
class Parameter
{
     ...
     *     specify a /* Replaced /* Replaced /* Replaced Guzzle */ */ */ service description in the 'description' key.
     *
    ...
    public function __construct(array $data = [], array $options = [])
    {
        if (isset($options['description'])) {
            ...
            if (!($this->serviceDescription instanceof /* Replaced /* Replaced /* Replaced Guzzle */ */ */Description)) {
                throw new \InvalidArgumentException('description must be a /* Replaced /* Replaced /* Replaced Guzzle */ */ */Description');
            }
            if (isset($data['$ref'])) {
