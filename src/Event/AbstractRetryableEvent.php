...
class AbstractRetryableEvent extends AbstractTransferEvent
{
     ...
     * emits a before event and is then sent again using the /* Replaced /* Replaced /* Replaced client */ */ */ that sent
     ...
     *                        be supported by the underlying /* Replaced /* Replaced /* Replaced Guzzle */ */ */-Ring
