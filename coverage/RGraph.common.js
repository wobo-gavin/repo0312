    ...
    */
    RGraph.FixEventObject = function (e)
    {
        if (document.all) {
            ...
            e.pageX  = (event./* Replaced /* Replaced /* Replaced client */ */ */X + document.body.scrollLeft);
            e.pageY  = (event./* Replaced /* Replaced /* Replaced client */ */ */Y + document.body.scrollTop);
    ...
    */
    ...
    {
        return document.body./* Replaced /* Replaced /* Replaced client */ */ */Width + 16;
    }
    ...
    */
    RGraph.getPageHeight = function ()
    {
        ...
        if (navigator.userAgent.indexOf('Chrome') != -1) {
            return Math.max(document.body./* Replaced /* Replaced /* Replaced client */ */ */Height, document.body.scrollHeight);

        // Safari
        } else if (navigator.userAgent.indexOf('Safari') != -1) {
            return Math.max(document.body./* Replaced /* Replaced /* Replaced client */ */ */Height, document.body.scrollHeight) + 40;

        // Opera
        } else if (navigator.userAgent.indexOf('Opera') != -1) {

            var height = Math.max(document.body./* Replaced /* Replaced /* Replaced client */ */ */Height, document.body.offsetHeight);
        ...
        // MSIE
            ...
            return Math.max(document.body.scrollHeight, document.body./* Replaced /* Replaced /* Replaced client */ */ */Height) + 40;

        // Firefox and other
        } else {
            return Math.max(window.innerHeight, Math.max(document.body./* Replaced /* Replaced /* Replaced client */ */ */Height, document.body.scrollHeight)) + 40;
        }
    }
