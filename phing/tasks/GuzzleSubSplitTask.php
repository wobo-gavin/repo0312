...
class /* Replaced /* Replaced /* Replaced Guzzle */ */ */SubSplitTask extends GitBaseTask
{
    /**
     ...
     */
    protected $/* Replaced /* Replaced /* Replaced client */ */ */   = null;
    ...
    public function main()
    {
        ...
        chdir($repo);
        $this->/* Replaced /* Replaced /* Replaced client */ */ */ = $this->getGitClient(false, $repo);
            ...
            foreach ($this->splits[$head] as $component => $meta) {
                ...
                if (!isset($existing_repos[$reponame])) {
                    ...
                    $payload = array(
                        ...
                        'homepage' => 'http://www./* Replaced /* Replaced /* Replaced guzzle */ */ */php.org/',
                        'private' => true,
                        'has_issues' => false,
                        'has_wiki' => false,
                        'has_downloads' => true,
