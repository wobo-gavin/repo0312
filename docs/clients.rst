...
:Summary: Describes the SSL certificate verification behavior of a request.
    ...
    - Set to ``"bundled"`` to use the CA bundle shipped with /* Replaced /* Replaced /* Replaced Guzzle */ */ */. This
...
.. code-block:: php
    ...
    $/* Replaced /* Replaced /* Replaced client */ */ */->get('/', ['verify' => 'bundled']);
...
.. note::
    ...
    Using the ``"bundled"`` setting uses the CA bundle packaged with /* Replaced /* Replaced /* Replaced Guzzle */ */ */.
    When running /* Replaced /* Replaced /* Replaced Guzzle */ */ */ through a phar, the ``"bundled"`` setting will copy
    ...
    copied to a file called ``/* Replaced /* Replaced /* Replaced guzzle */ */ */-cacert.pem`` in that directory. If it is
...
``GUZZLE_CA_EXTRACT_DIR``
    ...
    running /* Replaced /* Replaced /* Replaced Guzzle */ */ */ via a phar file and using the ``"bundled"``
