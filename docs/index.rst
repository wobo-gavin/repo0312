.. title:: /* Replaced /* Replaced Guzzle */ */, PHP HTTP /* Replaced /* Replaced client */ */

====================
/* Replaced /* Replaced Guzzle */ */ Documentation
====================
...
.. code-block:: php
    ...
    $res = $/* Replaced /* Replaced client */ */->request('GET', 'https://api.github.com/user', [
        'auth' => ['user', 'pass']
    ]);
