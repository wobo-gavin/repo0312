...
`PHP stream <http://php.net/manual/en/book.stream.php>`_ in /* Replaced /* Replaced /* Replaced Guzzle */ */ */. The body of the request can be either a string or
a PHP stream which are converted into a ``/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Http\EntityBody`` object using its factory method. When using a
...
calculate the Content-Length (when the resource is repeatable), guessing the Content-Type, and more. /* Replaced /* Replaced /* Replaced Guzzle */ */ */ doesn't
...
.. code-block:: php
    ...
    $response = $/* Replaced /* Replaced /* Replaced client */ */ */->put('http://localhost:8080/uploads', null, $body)->send();
...
``/* Replaced /* Replaced /* Replaced Guzzle */ */ */\Http\Message\EntityEnclosingRequestInterface`` object.
...
/* Replaced /* Replaced /* Replaced Guzzle */ */ */ provides several EntityBody decorators that can be used to add functionality to an EntityBody at runtime.
...
.. code-block:: php
    ...
    use /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Http\EntityBody;
    use /* Replaced /* Replaced /* Replaced Guzzle */ */ */\Http\CachingEntityBody;
