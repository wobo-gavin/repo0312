...
.. code-block:: php
    ...
    $/* Replaced /* Replaced /* Replaced client */ */ */ = new Client(['handler' => HandlerStack::create(new CurlMultiHandler([
        'options' => [
...
``X-/* Replaced /* Replaced /* Replaced Guzzle */ */ */-Redirect-History`` and the ``X-/* Replaced /* Replaced /* Replaced Guzzle */ */ */-Redirect-Status-History``
header respectively.
...
.. code-block:: php
    ...
    // First you configure /* Replaced /* Replaced /* Replaced Guzzle */ */ */ with redirect tracking and make a request
    ...
    $response = $/* Replaced /* Replaced /* Replaced client */ */ */->request('GET', $initialRequest); // Make your request

    // Retrieve both Redirect History headers
    $redirectUriHistory = $response->getHeader('X-/* Replaced /* Replaced /* Replaced Guzzle */ */ */-Redirect-History')[0]; // retrieve Redirect URI history
    $redirectCodeHistory = $response->getHeader('X-/* Replaced /* Replaced /* Replaced Guzzle */ */ */-Redirect-Status-History')[0]; // retrieve Redirect HTTP Status history
