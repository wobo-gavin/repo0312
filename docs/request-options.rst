...
:Summary: A function that accepts a ``/* Replaced /* Replaced /* Replaced Guzzle */ */ */Http\HandlerStack`` object before
    ...
    added by /* Replaced /* Replaced /* Replaced Guzzle */ */ */ (e.g., 'allow_redirects', 'http_errors', 'cookies', and
    'prepare_body').
:Types: callable
:Default: None

Each time a request is created, /* Replaced /* Replaced /* Replaced Guzzle */ */ */ will clone the /* Replaced /* Replaced /* Replaced client */ */ */'s handler stack
and use it to send the request. /* Replaced /* Replaced /* Replaced Guzzle */ */ */ adds a few middleware to the request's
handler stack based on the provided request options.

- If the ``allow_redirects`` option is set, /* Replaced /* Replaced /* Replaced Guzzle */ */ */ will add a middleware with
  the name ``allow_redirects``.
- If the ``http_errors`` request option is set, /* Replaced /* Replaced /* Replaced Guzzle */ */ */ will add a middleware
  with the name ``http_errors``.
- If the ``cookies`` request option is set, /* Replaced /* Replaced /* Replaced Guzzle */ */ */ will add a middleware with
  the name ``cookies``.
- Finally, /* Replaced /* Replaced /* Replaced Guzzle */ */ */ will always add a middleware called ``prepare_body`` which is
